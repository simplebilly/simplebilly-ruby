...
# Unit tests for SimplebillyApi::OssReportApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OssReportApi' do
  before do
  ...
  describe 'test an instance of OssReportApi' do
    it 'should create an instance of OssReportApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::OssReportApi)
    end
  end

  # unit tests for oss_report_api
  # @param [Hash] opts the optional parameters
  # @return [OssReport]
  describe 'oss_report_api test' do
    it 'should work' do

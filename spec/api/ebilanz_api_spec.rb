...
# Unit tests for SimplebillyApi::EbilanzApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EbilanzApi' do
  before do
  ...
  describe 'test an instance of EbilanzApi' do
    it 'should create an instance of EbilanzApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::EbilanzApi)
    end
  end

  # unit tests for ebilanz_report_api
  # @param [Hash] opts the optional parameters
  # @option opts [Integer] :year 
  # @option opts [String] :date_from 
  # @option opts [String] :date_to 
  # @return [EBilanzReport]
  describe 'ebilanz_report_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for ebilanz_xbrl_export_api
  # @param [Hash] opts the optional parameters
  # @option opts [Integer] :year 
  # @option opts [String] :date_from 
  # @option opts [String] :date_to 
  # @return [nil]
  describe 'ebilanz_xbrl_export_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

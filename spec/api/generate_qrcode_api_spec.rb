...
# Unit tests for SimplebillyApi::GenerateQrcodeApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'GenerateQrcodeApi' do
  before do
  ...
  describe 'test an instance of GenerateQrcodeApi' do
    it 'should create an instance of GenerateQrcodeApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::GenerateQrcodeApi)
    end
  end

  # unit tests for generate_qrcode_api
  # @param iban 
  # @param id 
  ...
  describe 'generate_qrcode_api test' do
    it 'should work' do

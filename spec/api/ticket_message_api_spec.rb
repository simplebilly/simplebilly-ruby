...
# Unit tests for SimplebillyApi::TicketMessageApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TicketMessageApi' do
  before do
  ...
  describe 'test an instance of TicketMessageApi' do
    it 'should create an instance of TicketMessageApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::TicketMessageApi)
    end
  end

  # unit tests for list_messages_api
  # @param ticket_id 
  # @param [Hash] opts the optional parameters
  # @return [Array<TicketMessage>]
  describe 'list_messages_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for send_message_api
  # @param ticket_id 
  # @param send_message_dto 
  # @param [Hash] opts the optional parameters
  # @return [TicketMessage]
  describe 'send_message_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

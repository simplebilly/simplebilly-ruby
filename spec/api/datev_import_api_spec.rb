...
# Unit tests for SimplebillyApi::DatevImportApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DatevImportApi' do
  before do
  ...
  describe 'test an instance of DatevImportApi' do
    it 'should create an instance of DatevImportApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::DatevImportApi)
    end
  end

  # unit tests for datev_import_api
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [DatevImportResponse]
  describe 'datev_import_api test' do
    it 'should work' do

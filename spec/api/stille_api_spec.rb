...
# Unit tests for SimplebillyApi::StilleApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StilleApi' do
  before do
  ...
  describe 'test an instance of StilleApi' do
    it 'should create an instance of StilleApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::StilleApi)
    end
  end

  # unit tests for stille_export_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @return [StilleExportResponse]
  describe 'stille_export_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for stille_report_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @return [StilleReport]
  describe 'stille_report_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

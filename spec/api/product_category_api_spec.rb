...
# Unit tests for SimplebillyApi::ProductCategoryApi
...
describe 'ProductCategoryApi' do
  ...
  describe 'test an instance of ProductCategoryApi' do
    it 'should create an instance of ProductCategoryApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::ProductCategoryApi)
    end
  end

  # unit tests for create_product_category
  # @param product_category 
  # @param [Hash] opts the optional parameters
  # @return [ProductCategory]
  describe 'create_product_category test' do
    it 'should work' do

...
# Unit tests for SimplebillyApi::InventoryValueApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InventoryValueApi' do
  before do
  ...
  describe 'test an instance of InventoryValueApi' do
    it 'should create an instance of InventoryValueApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::InventoryValueApi)
    end
  end

  # unit tests for get_inventory_value_api
  # @param [Hash] opts the optional parameters
  # @return [CurrentInventoryValue]
  describe 'get_inventory_value_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for record_inventory_value_api
  # @param [Hash] opts the optional parameters
  # @return [InventoryValuePoint]
  describe 'record_inventory_value_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

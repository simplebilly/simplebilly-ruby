...
# Unit tests for SimplebillyApi::AnlageGApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AnlageGApi' do
  before do
  ...
  describe 'test an instance of AnlageGApi' do
    it 'should create an instance of AnlageGApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::AnlageGApi)
    end
  end

  # unit tests for anlage_g_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @return [AnlageGErgebnis]
  describe 'anlage_g_api test' do
    it 'should work' do

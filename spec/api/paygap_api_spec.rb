...
# Unit tests for SimplebillyApi::PaygapApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PaygapApi' do
  before do
  ...
  describe 'test an instance of PaygapApi' do
    it 'should create an instance of PaygapApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::PaygapApi)
    end
  end

  # unit tests for paygap_auskunft_api
  # @param employee_id 
  # @param [Hash] opts the optional parameters
  # @return [PayGapInfoResponse]
  describe 'paygap_auskunft_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for paygap_export_api
  # @param [Hash] opts the optional parameters
  # @return [PayGapExportResponse]
  describe 'paygap_export_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for paygap_report_api
  # @param [Hash] opts the optional parameters
  # @return [PayGapReport]
  describe 'paygap_report_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

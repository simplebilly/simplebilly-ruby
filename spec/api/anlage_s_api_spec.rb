...
# Unit tests for SimplebillyApi::AnlageSApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AnlageSApi' do
  before do
  ...
  describe 'test an instance of AnlageSApi' do
    it 'should create an instance of AnlageSApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::AnlageSApi)
    end
  end

  # unit tests for anlage_s_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @return [AnlageSErgebnis]
  describe 'anlage_s_api test' do
    it 'should work' do

...
# Unit tests for SimplebillyApi::OffenlegungApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OffenlegungApi' do
  before do
  ...
  describe 'test an instance of OffenlegungApi' do
    it 'should create an instance of OffenlegungApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::OffenlegungApi)
    end
  end

  # unit tests for offenlegung_api
  # @param [Hash] opts the optional parameters
  # @return [OffenlegungReport]
  describe 'offenlegung_api test' do
    it 'should work' do

...
# Unit tests for SimplebillyApi::PeppolApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PeppolApi' do
  before do
  ...
  describe 'test an instance of PeppolApi' do
    it 'should create an instance of PeppolApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::PeppolApi)
    end
  end

  # unit tests for peppol_api
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [PeppolResponse]
  describe 'peppol_api test' do
    it 'should work' do

...
# Unit tests for SimplebillyApi::GewinnverwendungApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'GewinnverwendungApi' do
  before do
  ...
  describe 'test an instance of GewinnverwendungApi' do
    it 'should create an instance of GewinnverwendungApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::GewinnverwendungApi)
    end
  end

  # unit tests for gewinnverwendung_api
  # @param year 
  ...
  # unit tests for gewinnverwendung_export_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @return [GewinnverwendungsExportResponse]
  describe 'gewinnverwendung_export_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

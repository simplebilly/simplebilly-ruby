...
# Unit tests for SimplebillyApi::KostenVorschauApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'KostenVorschauApi' do
  before do
  ...
  describe 'test an instance of KostenVorschauApi' do
    it 'should create an instance of KostenVorschauApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::KostenVorschauApi)
    end
  end

  # unit tests for kosten_vorschau_api
  # @param year 
  # @param month 
  # @param [Hash] opts the optional parameters
  # @return [KostenVorschau]
  describe 'kosten_vorschau_api test' do
    it 'should work' do

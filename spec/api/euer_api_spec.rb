...
# Unit tests for SimplebillyApi::EuerApi
...
describe 'EuerApi' do
  ...
  describe 'test an instance of EuerApi' do
    it 'should create an instance of EuerApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::EuerApi)
    end
  end

  # unit tests for euer_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @return [EuerErgebnis]
  describe 'euer_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for euer_kategorien_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @return [EuerDetailErgebnis]
  describe 'euer_kategorien_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

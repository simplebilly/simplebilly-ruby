...
# Unit tests for SimplebillyApi::ShopApi
...
describe 'ShopApi' do
  ...
  describe 'test an instance of ShopApi' do
    it 'should create an instance of ShopApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::ShopApi)
    end
  end

  # unit tests for shop_editor_save
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'shop_editor_save test' do
    it 'should work' do

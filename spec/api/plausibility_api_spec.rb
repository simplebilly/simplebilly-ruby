...
# Unit tests for SimplebillyApi::PlausibilityApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PlausibilityApi' do
  before do
  ...
  describe 'test an instance of PlausibilityApi' do
    it 'should create an instance of PlausibilityApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::PlausibilityApi)
    end
  end

  # unit tests for plausibility_check_api
  # @param [Hash] opts the optional parameters
  # @option opts [String] :date_from 
  # @option opts [String] :date_to 
  # @return [PlausibilityReport]
  describe 'plausibility_check_api test' do
    it 'should work' do

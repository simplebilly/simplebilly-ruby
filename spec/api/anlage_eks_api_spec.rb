...
# Unit tests for SimplebillyApi::AnlageEksApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AnlageEksApi' do
  before do
  ...
  describe 'test an instance of AnlageEksApi' do
    it 'should create an instance of AnlageEksApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::AnlageEksApi)
    end
  end

  # unit tests for eks_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @return [EksErgebnis]
  describe 'eks_api test' do
    it 'should work' do

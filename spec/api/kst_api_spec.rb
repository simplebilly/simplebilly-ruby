...
# Unit tests for SimplebillyApi::KstApi
...
describe 'KstApi' do
  ...
  describe 'test an instance of KstApi' do
    it 'should create an instance of KstApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::KstApi)
    end
  end

  # unit tests for kst_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @option opts [String] :gewinn 
  # @return [KstErgebnis]
  describe 'kst_api test' do
    it 'should work' do

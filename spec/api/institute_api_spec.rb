...
# Unit tests for SimplebillyApi::InstituteApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstituteApi' do
  before do
  ...
  describe 'test an instance of InstituteApi' do
    it 'should create an instance of InstituteApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::InstituteApi)
    end
  end

  # unit tests for institute_status_api
  # @param [Hash] opts the optional parameters
  # @return [InstituteStatus]
  describe 'institute_status_api test' do
    it 'should work' do

...
# Unit tests for SimplebillyApi::GewerbesteuerApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'GewerbesteuerApi' do
  before do
  ...
  describe 'test an instance of GewerbesteuerApi' do
    it 'should create an instance of GewerbesteuerApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::GewerbesteuerApi)
    end
  end

  # unit tests for gewerbesteuer_api
  # @param year 
  ...
  describe 'gewerbesteuer_api test' do
    it 'should work' do

...
# Unit tests for SimplebillyApi::SuitabilityApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SuitabilityApi' do
  before do
  ...
  describe 'test an instance of SuitabilityApi' do
    it 'should create an instance of SuitabilityApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::SuitabilityApi)
    end
  end

  # unit tests for shipping_suitability_api
  # @param suitability_request 
  # @param [Hash] opts the optional parameters
  # @return [SuitabilityResult]
  describe 'shipping_suitability_api test' do
    it 'should work' do

...
# Unit tests for SimplebillyApi::BomApi
...
describe 'BomApi' do
  ...
  describe 'test an instance of BomApi' do
    it 'should create an instance of BomApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::BomApi)
    end
  end

  # unit tests for create_bom
  # @param bom_create 
  # @param [Hash] opts the optional parameters
  # @return [Bom]
  describe 'create_bom test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_bom
  # @param bom_id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_bom test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_bom
  # @param bom_id 
  # @param [Hash] opts the optional parameters
  # @return [Bom]
  describe 'get_bom test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_boms
  # @param [Hash] opts the optional parameters
  ...
  # @return [Array<Bom>]
  describe 'list_boms test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_bom
  # @param bom_id 
  # @param bom_update 
  # @param [Hash] opts the optional parameters
  # @return [Bom]
  describe 'update_bom test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

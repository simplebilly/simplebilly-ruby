...
# Unit tests for SimplebillyApi::KonzernApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'KonzernApi' do
  before do
  ...
  describe 'test an instance of KonzernApi' do
    it 'should create an instance of KonzernApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::KonzernApi)
    end
  end

  # unit tests for konzern_export_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @return [KonzernExportResponse]
  describe 'konzern_export_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for konzern_status_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @return [KonzernStatus]
  describe 'konzern_status_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

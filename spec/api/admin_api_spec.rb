...
# Unit tests for SimplebillyApi::AdminApi
...
describe 'AdminApi' do
  ...
  describe 'test an instance of AdminApi' do
    it 'should create an instance of AdminApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::AdminApi)
    end
  end

  # unit tests for trigger_mirror
  # @param [Hash] opts the optional parameters
  # @return [MirrorTriggerResponse]
  describe 'trigger_mirror test' do
    it 'should work' do

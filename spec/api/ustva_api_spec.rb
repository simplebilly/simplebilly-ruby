...
# Unit tests for SimplebillyApi::UstvaApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UstvaApi' do
  before do
  ...
  describe 'test an instance of UstvaApi' do
    it 'should create an instance of UstvaApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::UstvaApi)
    end
  end

  # unit tests for jahresust_api
  # @param year 
  # @param [Hash] opts the optional parameters
  # @return [JahresUstErgebnis]
  describe 'jahresust_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for ustva_api
  # @param zeitraum 
  # @param [Hash] opts the optional parameters
  # @return [UstvaErgebnis]
  describe 'ustva_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

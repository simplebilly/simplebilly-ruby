...
# Unit tests for SimplebillyApi::ShippingApi
...
describe 'ShippingApi' do
  ...
  describe 'test an instance of ShippingApi' do
    it 'should create an instance of ShippingApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::ShippingApi)
    end
  end

  # unit tests for get_credentials_api
  # @param [Hash] opts the optional parameters
  # @return [ShippingCredentials]
  describe 'get_credentials_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_rates_api
  # @param rate_request 
  # @param [Hash] opts the optional parameters
  # @return [RateResponse]
  describe 'get_rates_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_providers_api
  # @param [Hash] opts the optional parameters
  # @return [Array<ProviderInfo>]
  describe 'list_providers_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for save_credentials_api
  # @param shipping_credentials 
  # @param [Hash] opts the optional parameters
  # @return [ShippingCredentials]
  describe 'save_credentials_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

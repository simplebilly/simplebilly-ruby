...
# Unit tests for SimplebillyApi::WorkflowsApi
...
describe 'WorkflowsApi' do
  ...
  describe 'test an instance of WorkflowsApi' do
    it 'should create an instance of WorkflowsApi' do
      expect(@api_instance).to be_instance_of(SimplebillyApi::WorkflowsApi)
    end
  end

  # unit tests for list_workflows_api
  # @param [Hash] opts the optional parameters
  # @return [Array<Workflow>]
  describe 'list_workflows_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for set_workflow_enabled_api
  # @param workflow_id 
  # @param workflow_enabled_update 
  # @param [Hash] opts the optional parameters
  # @return [Workflow]
  describe 'set_workflow_enabled_api test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::ServiceJob
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ServiceJob do
  #let(:instance) { SimplebillyApi::ServiceJob.new }

  describe 'test an instance of ServiceJob' do
    it 'should create an instance of ServiceJob' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ServiceJob)
    end
  end

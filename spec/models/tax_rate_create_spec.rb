...
# Unit tests for SimplebillyApi::TaxRateCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TaxRateCreate do
  #let(:instance) { SimplebillyApi::TaxRateCreate.new }

  describe 'test an instance of TaxRateCreate' do
    it 'should create an instance of TaxRateCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TaxRateCreate)
    end
  end

...
# Unit tests for SimplebillyApi::MeteredUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::MeteredUsage do
  #let(:instance) { SimplebillyApi::MeteredUsage.new }

  describe 'test an instance of MeteredUsage' do
    it 'should create an instance of MeteredUsage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::MeteredUsage)
    end
  end

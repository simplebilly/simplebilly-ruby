...
# Unit tests for SimplebillyApi::CheckStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CheckStatus do
  #let(:instance) { SimplebillyApi::CheckStatus.new }

  describe 'test an instance of CheckStatus' do
    it 'should create an instance of CheckStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CheckStatus)
    end
  end

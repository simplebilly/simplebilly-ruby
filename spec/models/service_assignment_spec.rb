...
# Unit tests for SimplebillyApi::ServiceAssignment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ServiceAssignment do
  #let(:instance) { SimplebillyApi::ServiceAssignment.new }

  describe 'test an instance of ServiceAssignment' do
    it 'should create an instance of ServiceAssignment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ServiceAssignment)
    end
  end

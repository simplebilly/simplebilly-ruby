...
# Unit tests for SimplebillyApi::IncomeStatement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::IncomeStatement do
  #let(:instance) { SimplebillyApi::IncomeStatement.new }

  describe 'test an instance of IncomeStatement' do
    it 'should create an instance of IncomeStatement' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::IncomeStatement)
    end
  end

  describe 'test attribute "expense_items"' do
    it 'should work' do
  ...
  describe 'test attribute "revenue_items"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

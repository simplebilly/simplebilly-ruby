...
# Unit tests for SimplebillyApi::VerifyEmailRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::VerifyEmailRequest do
  #let(:instance) { SimplebillyApi::VerifyEmailRequest.new }

  describe 'test an instance of VerifyEmailRequest' do
    it 'should create an instance of VerifyEmailRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::VerifyEmailRequest)
    end
  end

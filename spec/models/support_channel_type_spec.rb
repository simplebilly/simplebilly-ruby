...
# Unit tests for SimplebillyApi::SupportChannelType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SupportChannelType do
  #let(:instance) { SimplebillyApi::SupportChannelType.new }

  describe 'test an instance of SupportChannelType' do
    it 'should create an instance of SupportChannelType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SupportChannelType)
    end
  end

...
# Unit tests for SimplebillyApi::BilanzItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::BilanzItem do
  #let(:instance) { SimplebillyApi::BilanzItem.new }

  describe 'test an instance of BilanzItem' do
    it 'should create an instance of BilanzItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::BilanzItem)
    end
  end

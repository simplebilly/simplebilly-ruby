...
# Unit tests for SimplebillyApi::ShippingRuleCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ShippingRuleCreate do
  #let(:instance) { SimplebillyApi::ShippingRuleCreate.new }

  describe 'test an instance of ShippingRuleCreate' do
    it 'should create an instance of ShippingRuleCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ShippingRuleCreate)
    end
  end

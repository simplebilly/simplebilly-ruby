...
# Unit tests for SimplebillyApi::PeppolResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PeppolResponse do
  #let(:instance) { SimplebillyApi::PeppolResponse.new }

  describe 'test an instance of PeppolResponse' do
    it 'should create an instance of PeppolResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PeppolResponse)
    end
  end

...
# Unit tests for SimplebillyApi::PublicPosting
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PublicPosting do
  #let(:instance) { SimplebillyApi::PublicPosting.new }

  describe 'test an instance of PublicPosting' do
    it 'should create an instance of PublicPosting' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PublicPosting)
    end
  end

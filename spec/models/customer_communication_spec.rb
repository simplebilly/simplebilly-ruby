...
# Unit tests for SimplebillyApi::CustomerCommunication
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CustomerCommunication do
  #let(:instance) { SimplebillyApi::CustomerCommunication.new }

  describe 'test an instance of CustomerCommunication' do
    it 'should create an instance of CustomerCommunication' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CustomerCommunication)
    end
  end

...
# Unit tests for SimplebillyApi::ReturnOrderStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ReturnOrderStatus do
  #let(:instance) { SimplebillyApi::ReturnOrderStatus.new }

  describe 'test an instance of ReturnOrderStatus' do
    it 'should create an instance of ReturnOrderStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ReturnOrderStatus)
    end
  end

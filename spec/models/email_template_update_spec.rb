...
# Unit tests for SimplebillyApi::EmailTemplateUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmailTemplateUpdate do
  #let(:instance) { SimplebillyApi::EmailTemplateUpdate.new }

  describe 'test an instance of EmailTemplateUpdate' do
    it 'should create an instance of EmailTemplateUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmailTemplateUpdate)
    end
  end

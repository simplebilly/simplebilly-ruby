...
# Unit tests for SimplebillyApi::GdprActivity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GdprActivity do
  #let(:instance) { SimplebillyApi::GdprActivity.new }

  describe 'test an instance of GdprActivity' do
    it 'should create an instance of GdprActivity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GdprActivity)
    end
  end

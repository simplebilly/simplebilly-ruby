...
# Unit tests for SimplebillyApi::StockTransfer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::StockTransfer do
  #let(:instance) { SimplebillyApi::StockTransfer.new }

  describe 'test an instance of StockTransfer' do
    it 'should create an instance of StockTransfer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::StockTransfer)
    end
  end

...
# Unit tests for SimplebillyApi::LeadUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::LeadUpdate do
  #let(:instance) { SimplebillyApi::LeadUpdate.new }

  describe 'test an instance of LeadUpdate' do
    it 'should create an instance of LeadUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::LeadUpdate)
    end
  end
  ...
  describe 'test attribute "first_contact_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::TimeEntryClockOut
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TimeEntryClockOut do
  #let(:instance) { SimplebillyApi::TimeEntryClockOut.new }

  describe 'test an instance of TimeEntryClockOut' do
    it 'should create an instance of TimeEntryClockOut' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TimeEntryClockOut)
    end
  end

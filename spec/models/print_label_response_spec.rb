...
# Unit tests for SimplebillyApi::PrintLabelResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PrintLabelResponse do
  #let(:instance) { SimplebillyApi::PrintLabelResponse.new }

  describe 'test an instance of PrintLabelResponse' do
    it 'should create an instance of PrintLabelResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PrintLabelResponse)
    end
  end
  ...
  describe 'test attribute "sscc"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::CartItemInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CartItemInput do
  #let(:instance) { SimplebillyApi::CartItemInput.new }

  describe 'test an instance of CartItemInput' do
    it 'should create an instance of CartItemInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CartItemInput)
    end
  end

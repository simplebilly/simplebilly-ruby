...
# Unit tests for SimplebillyApi::ActivityUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ActivityUpdate do
  #let(:instance) { SimplebillyApi::ActivityUpdate.new }

  describe 'test an instance of ActivityUpdate' do
    it 'should create an instance of ActivityUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ActivityUpdate)
    end
  end

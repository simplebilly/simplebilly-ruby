...
# Unit tests for SimplebillyApi::TimeEntryClockIn
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TimeEntryClockIn do
  #let(:instance) { SimplebillyApi::TimeEntryClockIn.new }

  describe 'test an instance of TimeEntryClockIn' do
    it 'should create an instance of TimeEntryClockIn' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TimeEntryClockIn)
    end
  end

...
# Unit tests for SimplebillyApi::ExecutionStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ExecutionStatus do
  #let(:instance) { SimplebillyApi::ExecutionStatus.new }

  describe 'test an instance of ExecutionStatus' do
    it 'should create an instance of ExecutionStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ExecutionStatus)
    end
  end

...
# Unit tests for SimplebillyApi::InvoiceStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::InvoiceStatus do
  #let(:instance) { SimplebillyApi::InvoiceStatus.new }

  describe 'test an instance of InvoiceStatus' do
    it 'should create an instance of InvoiceStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::InvoiceStatus)
    end
  end

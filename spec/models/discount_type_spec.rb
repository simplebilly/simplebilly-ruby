...
# Unit tests for SimplebillyApi::DiscountType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DiscountType do
  #let(:instance) { SimplebillyApi::DiscountType.new }

  describe 'test an instance of DiscountType' do
    it 'should create an instance of DiscountType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DiscountType)
    end
  end

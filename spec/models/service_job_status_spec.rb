...
# Unit tests for SimplebillyApi::ServiceJobStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ServiceJobStatus do
  #let(:instance) { SimplebillyApi::ServiceJobStatus.new }

  describe 'test an instance of ServiceJobStatus' do
    it 'should create an instance of ServiceJobStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ServiceJobStatus)
    end
  end

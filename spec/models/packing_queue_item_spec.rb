...
# Unit tests for SimplebillyApi::PackingQueueItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PackingQueueItem do
  #let(:instance) { SimplebillyApi::PackingQueueItem.new }

  describe 'test an instance of PackingQueueItem' do
    it 'should create an instance of PackingQueueItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PackingQueueItem)
    end
  end
  ...
  describe 'test attribute "delivery_note_printed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "label_printed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "video_recording"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

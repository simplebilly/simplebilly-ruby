...
# Unit tests for SimplebillyApi::ConnectorType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ConnectorType do
  #let(:instance) { SimplebillyApi::ConnectorType.new }

  describe 'test an instance of ConnectorType' do
    it 'should create an instance of ConnectorType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ConnectorType)
    end
  end

...
# Unit tests for SimplebillyApi::ShippingRuleUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ShippingRuleUpdate do
  #let(:instance) { SimplebillyApi::ShippingRuleUpdate.new }

  describe 'test an instance of ShippingRuleUpdate' do
    it 'should create an instance of ShippingRuleUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ShippingRuleUpdate)
    end
  end

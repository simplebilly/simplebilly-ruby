...
# Unit tests for SimplebillyApi::ConvertResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ConvertResponse do
  #let(:instance) { SimplebillyApi::ConvertResponse.new }

  describe 'test an instance of ConvertResponse' do
    it 'should create an instance of ConvertResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ConvertResponse)
    end
  end
  ...
  describe 'test attribute "proforma_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "proforma_number"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::EmissionFactorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmissionFactorResponse do
  #let(:instance) { SimplebillyApi::EmissionFactorResponse.new }

  describe 'test an instance of EmissionFactorResponse' do
    it 'should create an instance of EmissionFactorResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmissionFactorResponse)
    end
  end
  ...
  describe 'test attribute "kg_co2e_per_unit"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "name_de"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

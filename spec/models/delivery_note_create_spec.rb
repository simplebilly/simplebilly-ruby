...
# Unit tests for SimplebillyApi::DeliveryNoteCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DeliveryNoteCreate do
  #let(:instance) { SimplebillyApi::DeliveryNoteCreate.new }

  describe 'test an instance of DeliveryNoteCreate' do
    it 'should create an instance of DeliveryNoteCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DeliveryNoteCreate)
    end
  end

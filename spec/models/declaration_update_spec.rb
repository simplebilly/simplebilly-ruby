...
# Unit tests for SimplebillyApi::DeclarationUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DeclarationUpdate do
  #let(:instance) { SimplebillyApi::DeclarationUpdate.new }

  describe 'test an instance of DeclarationUpdate' do
    it 'should create an instance of DeclarationUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DeclarationUpdate)
    end
  end

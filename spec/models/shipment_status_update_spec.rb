...
# Unit tests for SimplebillyApi::ShipmentStatusUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ShipmentStatusUpdate do
  #let(:instance) { SimplebillyApi::ShipmentStatusUpdate.new }

  describe 'test an instance of ShipmentStatusUpdate' do
    it 'should create an instance of ShipmentStatusUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ShipmentStatusUpdate)
    end
  end

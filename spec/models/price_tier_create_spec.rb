...
# Unit tests for SimplebillyApi::PriceTierCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PriceTierCreate do
  #let(:instance) { SimplebillyApi::PriceTierCreate.new }

  describe 'test an instance of PriceTierCreate' do
    it 'should create an instance of PriceTierCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PriceTierCreate)
    end
  end

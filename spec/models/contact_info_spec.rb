...
# Unit tests for SimplebillyApi::ContactInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ContactInfo do
  #let(:instance) { SimplebillyApi::ContactInfo.new }

  describe 'test an instance of ContactInfo' do
    it 'should create an instance of ContactInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ContactInfo)
    end
  end
  ...
  describe 'test attribute "hint_en"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "role_en"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

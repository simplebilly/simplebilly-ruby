...
# Unit tests for SimplebillyApi::ChangePasswordRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ChangePasswordRequest do
  #let(:instance) { SimplebillyApi::ChangePasswordRequest.new }

  describe 'test an instance of ChangePasswordRequest' do
    it 'should create an instance of ChangePasswordRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ChangePasswordRequest)
    end
  end

...
# Unit tests for SimplebillyApi::ComplianceTraining
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ComplianceTraining do
  #let(:instance) { SimplebillyApi::ComplianceTraining.new }

  describe 'test an instance of ComplianceTraining' do
    it 'should create an instance of ComplianceTraining' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ComplianceTraining)
    end
  end

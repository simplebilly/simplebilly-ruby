...
# Unit tests for SimplebillyApi::EmploymentType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmploymentType do
  #let(:instance) { SimplebillyApi::EmploymentType.new }

  describe 'test an instance of EmploymentType' do
    it 'should create an instance of EmploymentType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmploymentType)
    end
  end

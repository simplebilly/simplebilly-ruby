...
# Unit tests for SimplebillyApi::PaymentGateway
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PaymentGateway do
  #let(:instance) { SimplebillyApi::PaymentGateway.new }

  describe 'test an instance of PaymentGateway' do
    it 'should create an instance of PaymentGateway' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PaymentGateway)
    end
  end

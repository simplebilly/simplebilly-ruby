...
# Unit tests for SimplebillyApi::TimeEntryDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TimeEntryDto do
  #let(:instance) { SimplebillyApi::TimeEntryDto.new }

  describe 'test an instance of TimeEntryDto' do
    it 'should create an instance of TimeEntryDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TimeEntryDto)
    end
  end

...
# Unit tests for SimplebillyApi::AiConfigDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::AiConfigDto do
  #let(:instance) { SimplebillyApi::AiConfigDto.new }

  describe 'test an instance of AiConfigDto' do
    it 'should create an instance of AiConfigDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::AiConfigDto)
    end
  end

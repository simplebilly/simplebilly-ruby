...
# Unit tests for SimplebillyApi::Quotation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Quotation do
  #let(:instance) { SimplebillyApi::Quotation.new }

  describe 'test an instance of Quotation' do
    it 'should create an instance of Quotation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Quotation)
    end
  end

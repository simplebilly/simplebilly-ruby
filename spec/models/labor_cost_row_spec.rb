...
# Unit tests for SimplebillyApi::LaborCostRow
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::LaborCostRow do
  #let(:instance) { SimplebillyApi::LaborCostRow.new }

  describe 'test an instance of LaborCostRow' do
    it 'should create an instance of LaborCostRow' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::LaborCostRow)
    end
  end

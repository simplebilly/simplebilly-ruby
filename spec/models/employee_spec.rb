...
# Unit tests for SimplebillyApi::Employee
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Employee do
  #let(:instance) { SimplebillyApi::Employee.new }

  describe 'test an instance of Employee' do
    it 'should create an instance of Employee' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Employee)
    end
  end

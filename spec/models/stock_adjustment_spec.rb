...
# Unit tests for SimplebillyApi::StockAdjustment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::StockAdjustment do
  #let(:instance) { SimplebillyApi::StockAdjustment.new }

  describe 'test an instance of StockAdjustment' do
    it 'should create an instance of StockAdjustment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::StockAdjustment)
    end
  end

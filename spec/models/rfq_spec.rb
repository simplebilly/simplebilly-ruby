...
# Unit tests for SimplebillyApi::Rfq
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Rfq do
  #let(:instance) { SimplebillyApi::Rfq.new }

  describe 'test an instance of Rfq' do
    it 'should create an instance of Rfq' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Rfq)
    end
  end

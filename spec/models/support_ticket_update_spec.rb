...
# Unit tests for SimplebillyApi::SupportTicketUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SupportTicketUpdate do
  #let(:instance) { SimplebillyApi::SupportTicketUpdate.new }

  describe 'test an instance of SupportTicketUpdate' do
    it 'should create an instance of SupportTicketUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SupportTicketUpdate)
    end
  end

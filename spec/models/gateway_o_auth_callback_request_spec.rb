...
# Unit tests for SimplebillyApi::GatewayOAuthCallbackRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GatewayOAuthCallbackRequest do
  #let(:instance) { SimplebillyApi::GatewayOAuthCallbackRequest.new }

  describe 'test an instance of GatewayOAuthCallbackRequest' do
    it 'should create an instance of GatewayOAuthCallbackRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GatewayOAuthCallbackRequest)
    end
  end

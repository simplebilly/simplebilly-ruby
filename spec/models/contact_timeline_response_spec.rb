...
# Unit tests for SimplebillyApi::ContactTimelineResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ContactTimelineResponse do
  #let(:instance) { SimplebillyApi::ContactTimelineResponse.new }

  describe 'test an instance of ContactTimelineResponse' do
    it 'should create an instance of ContactTimelineResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ContactTimelineResponse)
    end
  end

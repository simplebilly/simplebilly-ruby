...
# Unit tests for SimplebillyApi::TotpEnableRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TotpEnableRequest do
  #let(:instance) { SimplebillyApi::TotpEnableRequest.new }

  describe 'test an instance of TotpEnableRequest' do
    it 'should create an instance of TotpEnableRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TotpEnableRequest)
    end
  end

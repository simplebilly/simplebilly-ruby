...
# Unit tests for SimplebillyApi::ProductAttribute
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProductAttribute do
  #let(:instance) { SimplebillyApi::ProductAttribute.new }

  describe 'test an instance of ProductAttribute' do
    it 'should create an instance of ProductAttribute' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProductAttribute)
    end
  end

...
# Unit tests for SimplebillyApi::SupportChannel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SupportChannel do
  #let(:instance) { SimplebillyApi::SupportChannel.new }

  describe 'test an instance of SupportChannel' do
    it 'should create an instance of SupportChannel' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SupportChannel)
    end
  end

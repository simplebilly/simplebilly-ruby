...
# Unit tests for SimplebillyApi::CustomerCommunicationCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CustomerCommunicationCreate do
  #let(:instance) { SimplebillyApi::CustomerCommunicationCreate.new }

  describe 'test an instance of CustomerCommunicationCreate' do
    it 'should create an instance of CustomerCommunicationCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CustomerCommunicationCreate)
    end
  end

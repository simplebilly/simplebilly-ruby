...
# Unit tests for SimplebillyApi::LegalDocument
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::LegalDocument do
  #let(:instance) { SimplebillyApi::LegalDocument.new }

  describe 'test an instance of LegalDocument' do
    it 'should create an instance of LegalDocument' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::LegalDocument)
    end
  end

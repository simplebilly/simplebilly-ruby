...
# Unit tests for SimplebillyApi::ProformaInvoiceCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProformaInvoiceCreate do
  #let(:instance) { SimplebillyApi::ProformaInvoiceCreate.new }

  describe 'test an instance of ProformaInvoiceCreate' do
    it 'should create an instance of ProformaInvoiceCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProformaInvoiceCreate)
    end
  end

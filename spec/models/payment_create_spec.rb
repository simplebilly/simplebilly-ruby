...
# Unit tests for SimplebillyApi::PaymentCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PaymentCreate do
  #let(:instance) { SimplebillyApi::PaymentCreate.new }

  describe 'test an instance of PaymentCreate' do
    it 'should create an instance of PaymentCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PaymentCreate)
    end
  end

...
# Unit tests for SimplebillyApi::ActivityCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ActivityCreate do
  #let(:instance) { SimplebillyApi::ActivityCreate.new }

  describe 'test an instance of ActivityCreate' do
    it 'should create an instance of ActivityCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ActivityCreate)
    end
  end

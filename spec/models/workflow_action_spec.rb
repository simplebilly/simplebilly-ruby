...
# Unit tests for SimplebillyApi::WorkflowAction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::WorkflowAction do
  #let(:instance) { SimplebillyApi::WorkflowAction.new }

  describe 'test an instance of WorkflowAction' do
    it 'should create an instance of WorkflowAction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::WorkflowAction)
    end
  end

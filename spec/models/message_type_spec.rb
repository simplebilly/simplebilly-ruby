...
# Unit tests for SimplebillyApi::MessageType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::MessageType do
  #let(:instance) { SimplebillyApi::MessageType.new }

  describe 'test an instance of MessageType' do
    it 'should create an instance of MessageType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::MessageType)
    end
  end

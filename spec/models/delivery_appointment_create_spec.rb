...
# Unit tests for SimplebillyApi::DeliveryAppointmentCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DeliveryAppointmentCreate do
  #let(:instance) { SimplebillyApi::DeliveryAppointmentCreate.new }

  describe 'test an instance of DeliveryAppointmentCreate' do
    it 'should create an instance of DeliveryAppointmentCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DeliveryAppointmentCreate)
    end
  end

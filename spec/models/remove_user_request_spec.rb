...
# Unit tests for SimplebillyApi::RemoveUserRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::RemoveUserRequest do
  #let(:instance) { SimplebillyApi::RemoveUserRequest.new }

  describe 'test an instance of RemoveUserRequest' do
    it 'should create an instance of RemoveUserRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::RemoveUserRequest)
    end
  end

...
# Unit tests for SimplebillyApi::TenantUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TenantUser do
  #let(:instance) { SimplebillyApi::TenantUser.new }

  describe 'test an instance of TenantUser' do
    it 'should create an instance of TenantUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TenantUser)
    end
  end

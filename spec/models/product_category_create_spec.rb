...
# Unit tests for SimplebillyApi::ProductCategoryCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProductCategoryCreate do
  #let(:instance) { SimplebillyApi::ProductCategoryCreate.new }

  describe 'test an instance of ProductCategoryCreate' do
    it 'should create an instance of ProductCategoryCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProductCategoryCreate)
    end
  end

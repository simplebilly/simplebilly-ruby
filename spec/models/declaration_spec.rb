...
# Unit tests for SimplebillyApi::Declaration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Declaration do
  #let(:instance) { SimplebillyApi::Declaration.new }

  describe 'test an instance of Declaration' do
    it 'should create an instance of Declaration' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Declaration)
    end
  end

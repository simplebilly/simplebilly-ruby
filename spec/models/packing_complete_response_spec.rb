...
# Unit tests for SimplebillyApi::PackingCompleteResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PackingCompleteResponse do
  #let(:instance) { SimplebillyApi::PackingCompleteResponse.new }

  describe 'test an instance of PackingCompleteResponse' do
    it 'should create an instance of PackingCompleteResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PackingCompleteResponse)
    end
  end

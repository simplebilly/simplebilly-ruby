...
# Unit tests for SimplebillyApi::ReturnOrderStatusUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ReturnOrderStatusUpdate do
  #let(:instance) { SimplebillyApi::ReturnOrderStatusUpdate.new }

  describe 'test an instance of ReturnOrderStatusUpdate' do
    it 'should create an instance of ReturnOrderStatusUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ReturnOrderStatusUpdate)
    end
  end

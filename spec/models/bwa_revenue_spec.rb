...
# Unit tests for SimplebillyApi::BWARevenue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::BWARevenue do
  #let(:instance) { SimplebillyApi::BWARevenue.new }

  describe 'test an instance of BWARevenue' do
    it 'should create an instance of BWARevenue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::BWARevenue)
    end
  end

  describe 'test attribute "revenue_breakdown"' do
    it 'should work' do

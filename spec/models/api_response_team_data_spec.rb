...
# Unit tests for SimplebillyApi::ApiResponseTeamData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApiResponseTeamData do
  #let(:instance) { SimplebillyApi::ApiResponseTeamData.new }

  describe 'test an instance of ApiResponseTeamData' do
    it 'should create an instance of ApiResponseTeamData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApiResponseTeamData)
    end
  end

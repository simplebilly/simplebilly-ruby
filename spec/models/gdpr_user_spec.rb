...
# Unit tests for SimplebillyApi::GdprUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GdprUser do
  #let(:instance) { SimplebillyApi::GdprUser.new }

  describe 'test an instance of GdprUser' do
    it 'should create an instance of GdprUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GdprUser)
    end
  end

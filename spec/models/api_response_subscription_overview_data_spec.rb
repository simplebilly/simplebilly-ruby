...
# Unit tests for SimplebillyApi::ApiResponseSubscriptionOverviewData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApiResponseSubscriptionOverviewData do
  #let(:instance) { SimplebillyApi::ApiResponseSubscriptionOverviewData.new }

  describe 'test an instance of ApiResponseSubscriptionOverviewData' do
    it 'should create an instance of ApiResponseSubscriptionOverviewData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApiResponseSubscriptionOverviewData)
    end
  end

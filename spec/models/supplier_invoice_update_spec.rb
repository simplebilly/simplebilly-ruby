...
# Unit tests for SimplebillyApi::SupplierInvoiceUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SupplierInvoiceUpdate do
  #let(:instance) { SimplebillyApi::SupplierInvoiceUpdate.new }

  describe 'test an instance of SupplierInvoiceUpdate' do
    it 'should create an instance of SupplierInvoiceUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SupplierInvoiceUpdate)
    end
  end

...
# Unit tests for SimplebillyApi::ShareholderCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ShareholderCreate do
  #let(:instance) { SimplebillyApi::ShareholderCreate.new }

  describe 'test an instance of ShareholderCreate' do
    it 'should create an instance of ShareholderCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ShareholderCreate)
    end
  end
  ...
  describe 'test attribute "share_number"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

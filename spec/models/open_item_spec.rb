...
# Unit tests for SimplebillyApi::OpenItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OpenItem do
  #let(:instance) { SimplebillyApi::OpenItem.new }

  describe 'test an instance of OpenItem' do
    it 'should create an instance of OpenItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OpenItem)
    end
  end
  ...
  describe 'test attribute "days_overdue"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "reminder_level"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::AccountOverview
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::AccountOverview do
  #let(:instance) { SimplebillyApi::AccountOverview.new }

  describe 'test an instance of AccountOverview' do
    it 'should create an instance of AccountOverview' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::AccountOverview)
    end
  end
  ...
  describe 'test attribute "debit_total"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

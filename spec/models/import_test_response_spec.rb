...
# Unit tests for SimplebillyApi::ImportTestResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ImportTestResponse do
  #let(:instance) { SimplebillyApi::ImportTestResponse.new }

  describe 'test an instance of ImportTestResponse' do
    it 'should create an instance of ImportTestResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ImportTestResponse)
    end
  end

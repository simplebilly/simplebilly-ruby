...
# Unit tests for SimplebillyApi::SubmitResultDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SubmitResultDto do
  #let(:instance) { SimplebillyApi::SubmitResultDto.new }

  describe 'test an instance of SubmitResultDto' do
    it 'should create an instance of SubmitResultDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SubmitResultDto)
    end
  end
  ...
  describe 'test attribute "training_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::UpdateChannelDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::UpdateChannelDto do
  #let(:instance) { SimplebillyApi::UpdateChannelDto.new }

  describe 'test an instance of UpdateChannelDto' do
    it 'should create an instance of UpdateChannelDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::UpdateChannelDto)
    end
  end

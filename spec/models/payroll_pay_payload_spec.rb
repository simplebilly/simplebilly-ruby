...
# Unit tests for SimplebillyApi::PayrollPayPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PayrollPayPayload do
  #let(:instance) { SimplebillyApi::PayrollPayPayload.new }

  describe 'test an instance of PayrollPayPayload' do
    it 'should create an instance of PayrollPayPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PayrollPayPayload)
    end
  end

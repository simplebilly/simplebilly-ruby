...
# Unit tests for SimplebillyApi::QuotaOverview
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::QuotaOverview do
  #let(:instance) { SimplebillyApi::QuotaOverview.new }

  describe 'test an instance of QuotaOverview' do
    it 'should create an instance of QuotaOverview' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::QuotaOverview)
    end
  end

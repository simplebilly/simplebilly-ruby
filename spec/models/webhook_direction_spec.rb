...
# Unit tests for SimplebillyApi::WebhookDirection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::WebhookDirection do
  #let(:instance) { SimplebillyApi::WebhookDirection.new }

  describe 'test an instance of WebhookDirection' do
    it 'should create an instance of WebhookDirection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::WebhookDirection)
    end
  end

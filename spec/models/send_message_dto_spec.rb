...
# Unit tests for SimplebillyApi::SendMessageDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SendMessageDto do
  #let(:instance) { SimplebillyApi::SendMessageDto.new }

  describe 'test an instance of SendMessageDto' do
    it 'should create an instance of SendMessageDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SendMessageDto)
    end
  end

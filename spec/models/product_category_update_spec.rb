...
# Unit tests for SimplebillyApi::ProductCategoryUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProductCategoryUpdate do
  #let(:instance) { SimplebillyApi::ProductCategoryUpdate.new }

  describe 'test an instance of ProductCategoryUpdate' do
    it 'should create an instance of ProductCategoryUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProductCategoryUpdate)
    end
  end

...
# Unit tests for SimplebillyApi::EmployeeStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmployeeStatus do
  #let(:instance) { SimplebillyApi::EmployeeStatus.new }

  describe 'test an instance of EmployeeStatus' do
    it 'should create an instance of EmployeeStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmployeeStatus)
    end
  end

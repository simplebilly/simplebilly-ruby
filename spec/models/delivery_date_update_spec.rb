...
# Unit tests for SimplebillyApi::DeliveryDateUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DeliveryDateUpdate do
  #let(:instance) { SimplebillyApi::DeliveryDateUpdate.new }

  describe 'test an instance of DeliveryDateUpdate' do
    it 'should create an instance of DeliveryDateUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DeliveryDateUpdate)
    end
  end

...
# Unit tests for SimplebillyApi::EuerKatSumme
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EuerKatSumme do
  #let(:instance) { SimplebillyApi::EuerKatSumme.new }

  describe 'test an instance of EuerKatSumme' do
    it 'should create an instance of EuerKatSumme' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EuerKatSumme)
    end
  end

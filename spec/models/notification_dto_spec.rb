...
# Unit tests for SimplebillyApi::NotificationDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::NotificationDto do
  #let(:instance) { SimplebillyApi::NotificationDto.new }

  describe 'test an instance of NotificationDto' do
    it 'should create an instance of NotificationDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::NotificationDto)
    end
  end
  ...
  describe 'test attribute "sent_via_email"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

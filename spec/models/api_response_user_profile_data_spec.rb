...
# Unit tests for SimplebillyApi::ApiResponseUserProfileData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApiResponseUserProfileData do
  #let(:instance) { SimplebillyApi::ApiResponseUserProfileData.new }

  describe 'test an instance of ApiResponseUserProfileData' do
    it 'should create an instance of ApiResponseUserProfileData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApiResponseUserProfileData)
    end
  end

...
# Unit tests for SimplebillyApi::SyncLogStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SyncLogStatus do
  #let(:instance) { SimplebillyApi::SyncLogStatus.new }

  describe 'test an instance of SyncLogStatus' do
    it 'should create an instance of SyncLogStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SyncLogStatus)
    end
  end

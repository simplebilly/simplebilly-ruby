...
# Unit tests for SimplebillyApi::ProformaInvoiceUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProformaInvoiceUpdate do
  #let(:instance) { SimplebillyApi::ProformaInvoiceUpdate.new }

  describe 'test an instance of ProformaInvoiceUpdate' do
    it 'should create an instance of ProformaInvoiceUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProformaInvoiceUpdate)
    end
  end
  ...
  describe 'test attribute "converted_to_invoice_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "customer_snapshot"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "quotation_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

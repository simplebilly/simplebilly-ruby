...
# Unit tests for SimplebillyApi::NewVersionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::NewVersionRequest do
  #let(:instance) { SimplebillyApi::NewVersionRequest.new }

  describe 'test an instance of NewVersionRequest' do
    it 'should create an instance of NewVersionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::NewVersionRequest)
    end
  end

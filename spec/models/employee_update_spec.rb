...
# Unit tests for SimplebillyApi::EmployeeUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmployeeUpdate do
  #let(:instance) { SimplebillyApi::EmployeeUpdate.new }

  describe 'test an instance of EmployeeUpdate' do
    it 'should create an instance of EmployeeUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmployeeUpdate)
    end
  end

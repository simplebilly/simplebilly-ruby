...
# Unit tests for SimplebillyApi::ApplicationFilter
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApplicationFilter do
  #let(:instance) { SimplebillyApi::ApplicationFilter.new }

  describe 'test an instance of ApplicationFilter' do
    it 'should create an instance of ApplicationFilter' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApplicationFilter)
    end
  end

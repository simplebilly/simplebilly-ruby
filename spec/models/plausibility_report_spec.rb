...
# Unit tests for SimplebillyApi::PlausibilityReport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PlausibilityReport do
  #let(:instance) { SimplebillyApi::PlausibilityReport.new }

  describe 'test an instance of PlausibilityReport' do
    it 'should create an instance of PlausibilityReport' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PlausibilityReport)
    end
  end

...
# Unit tests for SimplebillyApi::PosRegisterStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PosRegisterStatus do
  #let(:instance) { SimplebillyApi::PosRegisterStatus.new }

  describe 'test an instance of PosRegisterStatus' do
    it 'should create an instance of PosRegisterStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PosRegisterStatus)
    end
  end

...
# Unit tests for SimplebillyApi::BomCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::BomCreate do
  #let(:instance) { SimplebillyApi::BomCreate.new }

  describe 'test an instance of BomCreate' do
    it 'should create an instance of BomCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::BomCreate)
    end
  end
  ...
  describe 'test attribute "output_quantity"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::ApiResponseString
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApiResponseString do
  #let(:instance) { SimplebillyApi::ApiResponseString.new }

  describe 'test an instance of ApiResponseString' do
    it 'should create an instance of ApiResponseString' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApiResponseString)
    end
  end

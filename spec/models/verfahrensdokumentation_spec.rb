...
# Unit tests for SimplebillyApi::Verfahrensdokumentation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Verfahrensdokumentation do
  #let(:instance) { SimplebillyApi::Verfahrensdokumentation.new }

  describe 'test an instance of Verfahrensdokumentation' do
    it 'should create an instance of Verfahrensdokumentation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Verfahrensdokumentation)
    end
  end

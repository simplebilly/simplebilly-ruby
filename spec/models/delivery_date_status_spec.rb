...
# Unit tests for SimplebillyApi::DeliveryDateStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DeliveryDateStatus do
  #let(:instance) { SimplebillyApi::DeliveryDateStatus.new }

  describe 'test an instance of DeliveryDateStatus' do
    it 'should create an instance of DeliveryDateStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DeliveryDateStatus)
    end
  end

...
# Unit tests for SimplebillyApi::AppointmentStatusUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::AppointmentStatusUpdate do
  #let(:instance) { SimplebillyApi::AppointmentStatusUpdate.new }

  describe 'test an instance of AppointmentStatusUpdate' do
    it 'should create an instance of AppointmentStatusUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::AppointmentStatusUpdate)
    end
  end

...
# Unit tests for SimplebillyApi::GdprBillingInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GdprBillingInfo do
  #let(:instance) { SimplebillyApi::GdprBillingInfo.new }

  describe 'test an instance of GdprBillingInfo' do
    it 'should create an instance of GdprBillingInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GdprBillingInfo)
    end
  end

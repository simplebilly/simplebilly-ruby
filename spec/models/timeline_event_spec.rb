...
# Unit tests for SimplebillyApi::TimelineEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TimelineEvent do
  #let(:instance) { SimplebillyApi::TimelineEvent.new }

  describe 'test an instance of TimelineEvent' do
    it 'should create an instance of TimelineEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TimelineEvent)
    end
  end

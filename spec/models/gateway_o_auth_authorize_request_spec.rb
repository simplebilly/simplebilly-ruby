...
# Unit tests for SimplebillyApi::GatewayOAuthAuthorizeRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GatewayOAuthAuthorizeRequest do
  #let(:instance) { SimplebillyApi::GatewayOAuthAuthorizeRequest.new }

  describe 'test an instance of GatewayOAuthAuthorizeRequest' do
    it 'should create an instance of GatewayOAuthAuthorizeRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GatewayOAuthAuthorizeRequest)
    end
  end

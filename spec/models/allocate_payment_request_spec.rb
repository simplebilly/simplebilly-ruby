...
# Unit tests for SimplebillyApi::AllocatePaymentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::AllocatePaymentRequest do
  #let(:instance) { SimplebillyApi::AllocatePaymentRequest.new }

  describe 'test an instance of AllocatePaymentRequest' do
    it 'should create an instance of AllocatePaymentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::AllocatePaymentRequest)
    end
  end

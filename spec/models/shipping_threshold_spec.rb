...
# Unit tests for SimplebillyApi::ShippingThreshold
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ShippingThreshold do
  #let(:instance) { SimplebillyApi::ShippingThreshold.new }

  describe 'test an instance of ShippingThreshold' do
    it 'should create an instance of ShippingThreshold' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ShippingThreshold)
    end
  end

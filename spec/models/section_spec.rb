...
# Unit tests for SimplebillyApi::Section
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Section do
  #let(:instance) { SimplebillyApi::Section.new }

  describe 'test an instance of Section' do
    it 'should create an instance of Section' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Section)
    end
  end
  ...
  describe 'test attribute "body_html_en"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::YearTotal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::YearTotal do
  #let(:instance) { SimplebillyApi::YearTotal.new }

  describe 'test an instance of YearTotal' do
    it 'should create an instance of YearTotal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::YearTotal)
    end
  end

...
# Unit tests for SimplebillyApi::RfqStatusUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::RfqStatusUpdate do
  #let(:instance) { SimplebillyApi::RfqStatusUpdate.new }

  describe 'test an instance of RfqStatusUpdate' do
    it 'should create an instance of RfqStatusUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::RfqStatusUpdate)
    end
  end

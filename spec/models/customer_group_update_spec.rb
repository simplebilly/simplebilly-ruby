...
# Unit tests for SimplebillyApi::CustomerGroupUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CustomerGroupUpdate do
  #let(:instance) { SimplebillyApi::CustomerGroupUpdate.new }

  describe 'test an instance of CustomerGroupUpdate' do
    it 'should create an instance of CustomerGroupUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CustomerGroupUpdate)
    end
  end

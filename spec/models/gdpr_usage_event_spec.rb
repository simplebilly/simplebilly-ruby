...
# Unit tests for SimplebillyApi::GdprUsageEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GdprUsageEvent do
  #let(:instance) { SimplebillyApi::GdprUsageEvent.new }

  describe 'test an instance of GdprUsageEvent' do
    it 'should create an instance of GdprUsageEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GdprUsageEvent)
    end
  end

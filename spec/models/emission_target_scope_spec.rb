...
# Unit tests for SimplebillyApi::EmissionTargetScope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmissionTargetScope do
  #let(:instance) { SimplebillyApi::EmissionTargetScope.new }

  describe 'test an instance of EmissionTargetScope' do
    it 'should create an instance of EmissionTargetScope' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmissionTargetScope)
    end
  end

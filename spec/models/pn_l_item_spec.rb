...
# Unit tests for SimplebillyApi::PnLItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PnLItem do
  #let(:instance) { SimplebillyApi::PnLItem.new }

  describe 'test an instance of PnLItem' do
    it 'should create an instance of PnLItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PnLItem)
    end
  end

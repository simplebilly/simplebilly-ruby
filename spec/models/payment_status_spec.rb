...
# Unit tests for SimplebillyApi::PaymentStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PaymentStatus do
  #let(:instance) { SimplebillyApi::PaymentStatus.new }

  describe 'test an instance of PaymentStatus' do
    it 'should create an instance of PaymentStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PaymentStatus)
    end
  end

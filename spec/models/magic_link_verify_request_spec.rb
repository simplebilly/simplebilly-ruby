...
# Unit tests for SimplebillyApi::MagicLinkVerifyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::MagicLinkVerifyRequest do
  #let(:instance) { SimplebillyApi::MagicLinkVerifyRequest.new }

  describe 'test an instance of MagicLinkVerifyRequest' do
    it 'should create an instance of MagicLinkVerifyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::MagicLinkVerifyRequest)
    end
  end

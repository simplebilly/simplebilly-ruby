...
# Unit tests for SimplebillyApi::ScopeTotal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ScopeTotal do
  #let(:instance) { SimplebillyApi::ScopeTotal.new }

  describe 'test an instance of ScopeTotal' do
    it 'should create an instance of ScopeTotal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ScopeTotal)
    end
  end

...
# Unit tests for SimplebillyApi::InventoryCountCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::InventoryCountCreate do
  #let(:instance) { SimplebillyApi::InventoryCountCreate.new }

  describe 'test an instance of InventoryCountCreate' do
    it 'should create an instance of InventoryCountCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::InventoryCountCreate)
    end
  end

  describe 'test attribute "count_date"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "count_number"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

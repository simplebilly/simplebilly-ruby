...
# Unit tests for SimplebillyApi::PackingCompleteRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PackingCompleteRequest do
  #let(:instance) { SimplebillyApi::PackingCompleteRequest.new }

  describe 'test an instance of PackingCompleteRequest' do
    it 'should create an instance of PackingCompleteRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PackingCompleteRequest)
    end
  end

...
# Unit tests for SimplebillyApi::DatevBookingPreview
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DatevBookingPreview do
  #let(:instance) { SimplebillyApi::DatevBookingPreview.new }

  describe 'test an instance of DatevBookingPreview' do
    it 'should create an instance of DatevBookingPreview' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DatevBookingPreview)
    end
  end
  ...
  describe 'test attribute "document_text"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

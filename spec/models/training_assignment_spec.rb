...
# Unit tests for SimplebillyApi::TrainingAssignment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TrainingAssignment do
  #let(:instance) { SimplebillyApi::TrainingAssignment.new }

  describe 'test an instance of TrainingAssignment' do
    it 'should create an instance of TrainingAssignment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TrainingAssignment)
    end
  end

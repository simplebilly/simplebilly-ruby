...
# Unit tests for SimplebillyApi::TrackOrderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TrackOrderRequest do
  #let(:instance) { SimplebillyApi::TrackOrderRequest.new }

  describe 'test an instance of TrackOrderRequest' do
    it 'should create an instance of TrackOrderRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TrackOrderRequest)
    end
  end

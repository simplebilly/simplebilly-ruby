...
# Unit tests for SimplebillyApi::LegalDocumentReset
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::LegalDocumentReset do
  #let(:instance) { SimplebillyApi::LegalDocumentReset.new }

  describe 'test an instance of LegalDocumentReset' do
    it 'should create an instance of LegalDocumentReset' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::LegalDocumentReset)
    end
  end

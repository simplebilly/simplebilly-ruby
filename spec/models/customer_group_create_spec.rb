...
# Unit tests for SimplebillyApi::CustomerGroupCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CustomerGroupCreate do
  #let(:instance) { SimplebillyApi::CustomerGroupCreate.new }

  describe 'test an instance of CustomerGroupCreate' do
    it 'should create an instance of CustomerGroupCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CustomerGroupCreate)
    end
  end
  ...
  describe 'test attribute "membership_filter"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

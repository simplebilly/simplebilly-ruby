...
# Unit tests for SimplebillyApi::Lead
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Lead do
  #let(:instance) { SimplebillyApi::Lead.new }

  describe 'test an instance of Lead' do
    it 'should create an instance of Lead' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Lead)
    end
  end

...
# Unit tests for SimplebillyApi::ProductAttributeUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProductAttributeUpdate do
  #let(:instance) { SimplebillyApi::ProductAttributeUpdate.new }

  describe 'test an instance of ProductAttributeUpdate' do
    it 'should create an instance of ProductAttributeUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProductAttributeUpdate)
    end
  end

  describe 'test attribute "is_filterable"' do
    it 'should work' do

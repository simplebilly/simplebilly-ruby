...
# Unit tests for SimplebillyApi::InstituteType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::InstituteType do
  #let(:instance) { SimplebillyApi::InstituteType.new }

  describe 'test an instance of InstituteType' do
    it 'should create an instance of InstituteType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::InstituteType)
    end
  end

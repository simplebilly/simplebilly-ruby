...
# Unit tests for SimplebillyApi::DhlCredentials
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DhlCredentials do
  #let(:instance) { SimplebillyApi::DhlCredentials.new }

  describe 'test an instance of DhlCredentials' do
    it 'should create an instance of DhlCredentials' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DhlCredentials)
    end
  end

...
# Unit tests for SimplebillyApi::Job
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Job do
  #let(:instance) { SimplebillyApi::Job.new }

  describe 'test an instance of Job' do
    it 'should create an instance of Job' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Job)
    end
  end
  ...
  describe 'test attribute "run_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::ActivityStatusUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ActivityStatusUpdate do
  #let(:instance) { SimplebillyApi::ActivityStatusUpdate.new }

  describe 'test an instance of ActivityStatusUpdate' do
    it 'should create an instance of ActivityStatusUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ActivityStatusUpdate)
    end
  end

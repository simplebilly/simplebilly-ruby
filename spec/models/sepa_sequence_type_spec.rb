...
# Unit tests for SimplebillyApi::SepaSequenceType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SepaSequenceType do
  #let(:instance) { SimplebillyApi::SepaSequenceType.new }

  describe 'test an instance of SepaSequenceType' do
    it 'should create an instance of SepaSequenceType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SepaSequenceType)
    end
  end

...
# Unit tests for SimplebillyApi::InventoryCount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::InventoryCount do
  #let(:instance) { SimplebillyApi::InventoryCount.new }

  describe 'test an instance of InventoryCount' do
    it 'should create an instance of InventoryCount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::InventoryCount)
    end
  end

...
# Unit tests for SimplebillyApi::PluginErrorOneOf1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PluginErrorOneOf1 do
  #let(:instance) { SimplebillyApi::PluginErrorOneOf1.new }

  describe 'test an instance of PluginErrorOneOf1' do
    it 'should create an instance of PluginErrorOneOf1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PluginErrorOneOf1)
    end
  end

...
# Unit tests for SimplebillyApi::OffenlegungItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OffenlegungItem do
  #let(:instance) { SimplebillyApi::OffenlegungItem.new }

  describe 'test an instance of OffenlegungItem' do
    it 'should create an instance of OffenlegungItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OffenlegungItem)
    end
  end

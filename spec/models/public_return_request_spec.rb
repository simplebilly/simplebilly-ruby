...
# Unit tests for SimplebillyApi::PublicReturnRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PublicReturnRequest do
  #let(:instance) { SimplebillyApi::PublicReturnRequest.new }

  describe 'test an instance of PublicReturnRequest' do
    it 'should create an instance of PublicReturnRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PublicReturnRequest)
    end
  end

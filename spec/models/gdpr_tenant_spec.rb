...
# Unit tests for SimplebillyApi::GdprTenant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GdprTenant do
  #let(:instance) { SimplebillyApi::GdprTenant.new }

  describe 'test an instance of GdprTenant' do
    it 'should create an instance of GdprTenant' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GdprTenant)
    end
  end

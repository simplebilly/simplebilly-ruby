...
# Unit tests for SimplebillyApi::AbsenceType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::AbsenceType do
  #let(:instance) { SimplebillyApi::AbsenceType.new }

  describe 'test an instance of AbsenceType' do
    it 'should create an instance of AbsenceType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::AbsenceType)
    end
  end

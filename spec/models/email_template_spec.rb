...
# Unit tests for SimplebillyApi::EmailTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmailTemplate do
  #let(:instance) { SimplebillyApi::EmailTemplate.new }

  describe 'test an instance of EmailTemplate' do
    it 'should create an instance of EmailTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmailTemplate)
    end
  end

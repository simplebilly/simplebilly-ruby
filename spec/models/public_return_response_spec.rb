...
# Unit tests for SimplebillyApi::PublicReturnResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PublicReturnResponse do
  #let(:instance) { SimplebillyApi::PublicReturnResponse.new }

  describe 'test an instance of PublicReturnResponse' do
    it 'should create an instance of PublicReturnResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PublicReturnResponse)
    end
  end

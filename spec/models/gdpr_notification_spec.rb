...
# Unit tests for SimplebillyApi::GdprNotification
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GdprNotification do
  #let(:instance) { SimplebillyApi::GdprNotification.new }

  describe 'test an instance of GdprNotification' do
    it 'should create an instance of GdprNotification' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GdprNotification)
    end
  end

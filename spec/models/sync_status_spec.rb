...
# Unit tests for SimplebillyApi::SyncStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SyncStatus do
  #let(:instance) { SimplebillyApi::SyncStatus.new }

  describe 'test an instance of SyncStatus' do
    it 'should create an instance of SyncStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SyncStatus)
    end
  end

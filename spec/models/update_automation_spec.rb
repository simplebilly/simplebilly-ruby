...
# Unit tests for SimplebillyApi::UpdateAutomation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::UpdateAutomation do
  #let(:instance) { SimplebillyApi::UpdateAutomation.new }

  describe 'test an instance of UpdateAutomation' do
    it 'should create an instance of UpdateAutomation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::UpdateAutomation)
    end
  end

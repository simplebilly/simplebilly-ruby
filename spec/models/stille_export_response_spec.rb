...
# Unit tests for SimplebillyApi::StilleExportResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::StilleExportResponse do
  #let(:instance) { SimplebillyApi::StilleExportResponse.new }

  describe 'test an instance of StilleExportResponse' do
    it 'should create an instance of StilleExportResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::StilleExportResponse)
    end
  end

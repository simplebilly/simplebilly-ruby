...
# Unit tests for SimplebillyApi::DatevImportResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DatevImportResponse do
  #let(:instance) { SimplebillyApi::DatevImportResponse.new }

  describe 'test an instance of DatevImportResponse' do
    it 'should create an instance of DatevImportResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DatevImportResponse)
    end
  end

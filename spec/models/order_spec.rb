...
# Unit tests for SimplebillyApi::Order
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Order do
  #let(:instance) { SimplebillyApi::Order.new }

  describe 'test an instance of Order' do
    it 'should create an instance of Order' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Order)
    end
  end

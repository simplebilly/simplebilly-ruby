...
# Unit tests for SimplebillyApi::ProductVariantCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProductVariantCreate do
  #let(:instance) { SimplebillyApi::ProductVariantCreate.new }

  describe 'test an instance of ProductVariantCreate' do
    it 'should create an instance of ProductVariantCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProductVariantCreate)
    end
  end

...
# Unit tests for SimplebillyApi::MovementType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::MovementType do
  #let(:instance) { SimplebillyApi::MovementType.new }

  describe 'test an instance of MovementType' do
    it 'should create an instance of MovementType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::MovementType)
    end
  end

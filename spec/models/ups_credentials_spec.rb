...
# Unit tests for SimplebillyApi::UpsCredentials
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::UpsCredentials do
  #let(:instance) { SimplebillyApi::UpsCredentials.new }

  describe 'test an instance of UpsCredentials' do
    it 'should create an instance of UpsCredentials' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::UpsCredentials)
    end
  end
  ...
  describe 'test attribute "shipper_number"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::GdprExport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GdprExport do
  #let(:instance) { SimplebillyApi::GdprExport.new }

  describe 'test an instance of GdprExport' do
    it 'should create an instance of GdprExport' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GdprExport)
    end
  end

...
# Unit tests for SimplebillyApi::PluginErrorOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PluginErrorOneOf do
  #let(:instance) { SimplebillyApi::PluginErrorOneOf.new }

  describe 'test an instance of PluginErrorOneOf' do
    it 'should create an instance of PluginErrorOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PluginErrorOneOf)
    end
  end

  describe 'test attribute "bad_request"' do
    it 'should work' do

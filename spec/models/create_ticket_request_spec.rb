...
# Unit tests for SimplebillyApi::CreateTicketRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CreateTicketRequest do
  #let(:instance) { SimplebillyApi::CreateTicketRequest.new }

  describe 'test an instance of CreateTicketRequest' do
    it 'should create an instance of CreateTicketRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CreateTicketRequest)
    end
  end

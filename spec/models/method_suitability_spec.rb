...
# Unit tests for SimplebillyApi::MethodSuitability
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::MethodSuitability do
  #let(:instance) { SimplebillyApi::MethodSuitability.new }

  describe 'test an instance of MethodSuitability' do
    it 'should create an instance of MethodSuitability' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::MethodSuitability)
    end
  end
  ...
  describe 'test attribute "suitable"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

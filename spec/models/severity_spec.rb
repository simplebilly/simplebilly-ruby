...
# Unit tests for SimplebillyApi::Severity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Severity do
  #let(:instance) { SimplebillyApi::Severity.new }

  describe 'test an instance of Severity' do
    it 'should create an instance of Severity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Severity)
    end
  end

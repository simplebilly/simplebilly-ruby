...
# Unit tests for SimplebillyApi::Bom
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Bom do
  #let(:instance) { SimplebillyApi::Bom.new }

  describe 'test an instance of Bom' do
    it 'should create an instance of Bom' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Bom)
    end
  end

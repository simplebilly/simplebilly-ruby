...
# Unit tests for SimplebillyApi::VatItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::VatItem do
  #let(:instance) { SimplebillyApi::VatItem.new }

  describe 'test an instance of VatItem' do
    it 'should create an instance of VatItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::VatItem)
    end
  end

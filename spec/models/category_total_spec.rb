...
# Unit tests for SimplebillyApi::CategoryTotal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CategoryTotal do
  #let(:instance) { SimplebillyApi::CategoryTotal.new }

  describe 'test an instance of CategoryTotal' do
    it 'should create an instance of CategoryTotal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CategoryTotal)
    end
  end
  ...
  describe 'test attribute "share_pct"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

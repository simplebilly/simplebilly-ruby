...
# Unit tests for SimplebillyApi::ShippingThresholdUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ShippingThresholdUpdate do
  #let(:instance) { SimplebillyApi::ShippingThresholdUpdate.new }

  describe 'test an instance of ShippingThresholdUpdate' do
    it 'should create an instance of ShippingThresholdUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ShippingThresholdUpdate)
    end
  end

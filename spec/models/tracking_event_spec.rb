...
# Unit tests for SimplebillyApi::TrackingEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TrackingEvent do
  #let(:instance) { SimplebillyApi::TrackingEvent.new }

  describe 'test an instance of TrackingEvent' do
    it 'should create an instance of TrackingEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TrackingEvent)
    end
  end

...
# Unit tests for SimplebillyApi::PriceTierUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PriceTierUpdate do
  #let(:instance) { SimplebillyApi::PriceTierUpdate.new }

  describe 'test an instance of PriceTierUpdate' do
    it 'should create an instance of PriceTierUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PriceTierUpdate)
    end
  end

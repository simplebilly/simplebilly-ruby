...
# Unit tests for SimplebillyApi::UsageSnapshot
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::UsageSnapshot do
  #let(:instance) { SimplebillyApi::UsageSnapshot.new }

  describe 'test an instance of UsageSnapshot' do
    it 'should create an instance of UsageSnapshot' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::UsageSnapshot)
    end
  end
  ...
  describe 'test attribute "invoices_this_month"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "overage_seats"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

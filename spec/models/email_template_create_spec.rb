...
# Unit tests for SimplebillyApi::EmailTemplateCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmailTemplateCreate do
  #let(:instance) { SimplebillyApi::EmailTemplateCreate.new }

  describe 'test an instance of EmailTemplateCreate' do
    it 'should create an instance of EmailTemplateCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmailTemplateCreate)
    end
  end

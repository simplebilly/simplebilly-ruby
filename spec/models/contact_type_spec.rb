...
# Unit tests for SimplebillyApi::ContactType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ContactType do
  #let(:instance) { SimplebillyApi::ContactType.new }

  describe 'test an instance of ContactType' do
    it 'should create an instance of ContactType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ContactType)
    end
  end

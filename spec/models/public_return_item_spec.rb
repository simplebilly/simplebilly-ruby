...
# Unit tests for SimplebillyApi::PublicReturnItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PublicReturnItem do
  #let(:instance) { SimplebillyApi::PublicReturnItem.new }

  describe 'test an instance of PublicReturnItem' do
    it 'should create an instance of PublicReturnItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PublicReturnItem)
    end
  end

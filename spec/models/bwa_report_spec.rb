...
# Unit tests for SimplebillyApi::BWAReport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::BWAReport do
  #let(:instance) { SimplebillyApi::BWAReport.new }

  describe 'test an instance of BWAReport' do
    it 'should create an instance of BWAReport' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::BWAReport)
    end
  end

...
# Unit tests for SimplebillyApi::CouponUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CouponUpdate do
  #let(:instance) { SimplebillyApi::CouponUpdate.new }

  describe 'test an instance of CouponUpdate' do
    it 'should create an instance of CouponUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CouponUpdate)
    end
  end

...
# Unit tests for SimplebillyApi::WarehouseCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::WarehouseCreate do
  #let(:instance) { SimplebillyApi::WarehouseCreate.new }

  describe 'test an instance of WarehouseCreate' do
    it 'should create an instance of WarehouseCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::WarehouseCreate)
    end
  end
  ...
  describe 'test attribute "bin_locations"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::ImportTestRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ImportTestRequest do
  #let(:instance) { SimplebillyApi::ImportTestRequest.new }

  describe 'test an instance of ImportTestRequest' do
    it 'should create an instance of ImportTestRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ImportTestRequest)
    end
  end

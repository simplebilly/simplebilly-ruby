...
# Unit tests for SimplebillyApi::MagicLinkRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::MagicLinkRequest do
  #let(:instance) { SimplebillyApi::MagicLinkRequest.new }

  describe 'test an instance of MagicLinkRequest' do
    it 'should create an instance of MagicLinkRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::MagicLinkRequest)
    end
  end

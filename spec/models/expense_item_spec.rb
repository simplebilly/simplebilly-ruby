...
# Unit tests for SimplebillyApi::ExpenseItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ExpenseItem do
  #let(:instance) { SimplebillyApi::ExpenseItem.new }

  describe 'test an instance of ExpenseItem' do
    it 'should create an instance of ExpenseItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ExpenseItem)
    end
  end

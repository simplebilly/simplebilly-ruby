...
# Unit tests for SimplebillyApi::BalanceItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::BalanceItem do
  #let(:instance) { SimplebillyApi::BalanceItem.new }

  describe 'test an instance of BalanceItem' do
    it 'should create an instance of BalanceItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::BalanceItem)
    end
  end

...
# Unit tests for SimplebillyApi::ConfigFieldKindOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ConfigFieldKindOneOf do
  #let(:instance) { SimplebillyApi::ConfigFieldKindOneOf.new }

  describe 'test an instance of ConfigFieldKindOneOf' do
    it 'should create an instance of ConfigFieldKindOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ConfigFieldKindOneOf)
    end
  end

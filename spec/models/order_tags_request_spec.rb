...
# Unit tests for SimplebillyApi::OrderTagsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OrderTagsRequest do
  #let(:instance) { SimplebillyApi::OrderTagsRequest.new }

  describe 'test an instance of OrderTagsRequest' do
    it 'should create an instance of OrderTagsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OrderTagsRequest)
    end
  end

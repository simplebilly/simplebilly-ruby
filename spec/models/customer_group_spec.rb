...
# Unit tests for SimplebillyApi::CustomerGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CustomerGroup do
  #let(:instance) { SimplebillyApi::CustomerGroup.new }

  describe 'test an instance of CustomerGroup' do
    it 'should create an instance of CustomerGroup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CustomerGroup)
    end
  end

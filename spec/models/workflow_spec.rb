...
# Unit tests for SimplebillyApi::Workflow
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Workflow do
  #let(:instance) { SimplebillyApi::Workflow.new }

  describe 'test an instance of Workflow' do
    it 'should create an instance of Workflow' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Workflow)
    end
  end

...
# Unit tests for SimplebillyApi::KycRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::KycRecord do
  #let(:instance) { SimplebillyApi::KycRecord.new }

  describe 'test an instance of KycRecord' do
    it 'should create an instance of KycRecord' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::KycRecord)
    end
  end

...
# Unit tests for SimplebillyApi::StockUpdateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::StockUpdateRequest do
  #let(:instance) { SimplebillyApi::StockUpdateRequest.new }

  describe 'test an instance of StockUpdateRequest' do
    it 'should create an instance of StockUpdateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::StockUpdateRequest)
    end
  end

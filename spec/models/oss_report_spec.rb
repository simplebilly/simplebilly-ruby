...
# Unit tests for SimplebillyApi::OssReport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OssReport do
  #let(:instance) { SimplebillyApi::OssReport.new }

  describe 'test an instance of OssReport' do
    it 'should create an instance of OssReport' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OssReport)
    end
  end

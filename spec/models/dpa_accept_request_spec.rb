...
# Unit tests for SimplebillyApi::DpaAcceptRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DpaAcceptRequest do
  #let(:instance) { SimplebillyApi::DpaAcceptRequest.new }

  describe 'test an instance of DpaAcceptRequest' do
    it 'should create an instance of DpaAcceptRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DpaAcceptRequest)
    end
  end

  describe 'test attribute "accepted_by_name"' do
    it 'should work' do

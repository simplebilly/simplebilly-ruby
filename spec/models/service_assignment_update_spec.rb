...
# Unit tests for SimplebillyApi::ServiceAssignmentUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ServiceAssignmentUpdate do
  #let(:instance) { SimplebillyApi::ServiceAssignmentUpdate.new }

  describe 'test an instance of ServiceAssignmentUpdate' do
    it 'should create an instance of ServiceAssignmentUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ServiceAssignmentUpdate)
    end
  end

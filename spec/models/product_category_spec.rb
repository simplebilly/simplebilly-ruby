...
# Unit tests for SimplebillyApi::ProductCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProductCategory do
  #let(:instance) { SimplebillyApi::ProductCategory.new }

  describe 'test an instance of ProductCategory' do
    it 'should create an instance of ProductCategory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProductCategory)
    end
  end

...
# Unit tests for SimplebillyApi::PayrollAutopayPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PayrollAutopayPayload do
  #let(:instance) { SimplebillyApi::PayrollAutopayPayload.new }

  describe 'test an instance of PayrollAutopayPayload' do
    it 'should create an instance of PayrollAutopayPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PayrollAutopayPayload)
    end
  end

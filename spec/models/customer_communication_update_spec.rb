...
# Unit tests for SimplebillyApi::CustomerCommunicationUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CustomerCommunicationUpdate do
  #let(:instance) { SimplebillyApi::CustomerCommunicationUpdate.new }

  describe 'test an instance of CustomerCommunicationUpdate' do
    it 'should create an instance of CustomerCommunicationUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CustomerCommunicationUpdate)
    end
  end

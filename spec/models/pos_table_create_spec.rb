...
# Unit tests for SimplebillyApi::PosTableCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PosTableCreate do
  #let(:instance) { SimplebillyApi::PosTableCreate.new }

  describe 'test an instance of PosTableCreate' do
    it 'should create an instance of PosTableCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PosTableCreate)
    end
  end

  describe 'test attribute "current_order_number"' do
    it 'should work' do

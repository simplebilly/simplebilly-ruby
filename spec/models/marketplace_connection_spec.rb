...
# Unit tests for SimplebillyApi::MarketplaceConnection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::MarketplaceConnection do
  #let(:instance) { SimplebillyApi::MarketplaceConnection.new }

  describe 'test an instance of MarketplaceConnection' do
    it 'should create an instance of MarketplaceConnection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::MarketplaceConnection)
    end
  end
  ...
  describe 'test attribute "shop_domain"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

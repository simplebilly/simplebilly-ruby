...
# Unit tests for SimplebillyApi::GdprApiKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GdprApiKey do
  #let(:instance) { SimplebillyApi::GdprApiKey.new }

  describe 'test an instance of GdprApiKey' do
    it 'should create an instance of GdprApiKey' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GdprApiKey)
    end
  end

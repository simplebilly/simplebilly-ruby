...
# Unit tests for SimplebillyApi::ChangelogEntry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ChangelogEntry do
  #let(:instance) { SimplebillyApi::ChangelogEntry.new }

  describe 'test an instance of ChangelogEntry' do
    it 'should create an instance of ChangelogEntry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ChangelogEntry)
    end
  end

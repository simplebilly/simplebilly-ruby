...
# Unit tests for SimplebillyApi::SupportTicketStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SupportTicketStatus do
  #let(:instance) { SimplebillyApi::SupportTicketStatus.new }

  describe 'test an instance of SupportTicketStatus' do
    it 'should create an instance of SupportTicketStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SupportTicketStatus)
    end
  end

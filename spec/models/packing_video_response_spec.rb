...
# Unit tests for SimplebillyApi::PackingVideoResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PackingVideoResponse do
  #let(:instance) { SimplebillyApi::PackingVideoResponse.new }

  describe 'test an instance of PackingVideoResponse' do
    it 'should create an instance of PackingVideoResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PackingVideoResponse)
    end
  end

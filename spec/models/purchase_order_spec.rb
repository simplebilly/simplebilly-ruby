...
# Unit tests for SimplebillyApi::PurchaseOrder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PurchaseOrder do
  #let(:instance) { SimplebillyApi::PurchaseOrder.new }

  describe 'test an instance of PurchaseOrder' do
    it 'should create an instance of PurchaseOrder' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PurchaseOrder)
    end
  end

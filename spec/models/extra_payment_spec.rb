...
# Unit tests for SimplebillyApi::ExtraPayment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ExtraPayment do
  #let(:instance) { SimplebillyApi::ExtraPayment.new }

  describe 'test an instance of ExtraPayment' do
    it 'should create an instance of ExtraPayment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ExtraPayment)
    end
  end

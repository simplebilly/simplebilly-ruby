...
# Unit tests for SimplebillyApi::CommunicationDirection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CommunicationDirection do
  #let(:instance) { SimplebillyApi::CommunicationDirection.new }

  describe 'test an instance of CommunicationDirection' do
    it 'should create an instance of CommunicationDirection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CommunicationDirection)
    end
  end

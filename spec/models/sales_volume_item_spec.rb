...
# Unit tests for SimplebillyApi::SalesVolumeItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SalesVolumeItem do
  #let(:instance) { SimplebillyApi::SalesVolumeItem.new }

  describe 'test an instance of SalesVolumeItem' do
    it 'should create an instance of SalesVolumeItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SalesVolumeItem)
    end
  end

...
# Unit tests for SimplebillyApi::ComplianceEntry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ComplianceEntry do
  #let(:instance) { SimplebillyApi::ComplianceEntry.new }

  describe 'test an instance of ComplianceEntry' do
    it 'should create an instance of ComplianceEntry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ComplianceEntry)
    end
  end
  ...
  describe 'test attribute "regulations"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

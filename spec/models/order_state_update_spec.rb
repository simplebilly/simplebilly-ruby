...
# Unit tests for SimplebillyApi::OrderStateUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OrderStateUpdate do
  #let(:instance) { SimplebillyApi::OrderStateUpdate.new }

  describe 'test an instance of OrderStateUpdate' do
    it 'should create an instance of OrderStateUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OrderStateUpdate)
    end
  end

  describe 'test attribute "send_state_to_shop"' do
    it 'should work' do

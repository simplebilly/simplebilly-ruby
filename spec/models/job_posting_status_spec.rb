...
# Unit tests for SimplebillyApi::JobPostingStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::JobPostingStatus do
  #let(:instance) { SimplebillyApi::JobPostingStatus.new }

  describe 'test an instance of JobPostingStatus' do
    it 'should create an instance of JobPostingStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::JobPostingStatus)
    end
  end

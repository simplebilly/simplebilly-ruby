...
# Unit tests for SimplebillyApi::EmissionsExportResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmissionsExportResponse do
  #let(:instance) { SimplebillyApi::EmissionsExportResponse.new }

  describe 'test an instance of EmissionsExportResponse' do
    it 'should create an instance of EmissionsExportResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmissionsExportResponse)
    end
  end

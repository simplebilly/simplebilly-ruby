...
# Unit tests for SimplebillyApi::Product
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Product do
  #let(:instance) { SimplebillyApi::Product.new }

  describe 'test an instance of Product' do
    it 'should create an instance of Product' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Product)
    end
  end

...
# Unit tests for SimplebillyApi::PosRegisterCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PosRegisterCreate do
  #let(:instance) { SimplebillyApi::PosRegisterCreate.new }

  describe 'test an instance of PosRegisterCreate' do
    it 'should create an instance of PosRegisterCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PosRegisterCreate)
    end
  end

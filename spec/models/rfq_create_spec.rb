...
# Unit tests for SimplebillyApi::RfqCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::RfqCreate do
  #let(:instance) { SimplebillyApi::RfqCreate.new }

  describe 'test an instance of RfqCreate' do
    it 'should create an instance of RfqCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::RfqCreate)
    end
  end

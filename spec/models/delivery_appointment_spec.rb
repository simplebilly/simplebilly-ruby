...
# Unit tests for SimplebillyApi::DeliveryAppointment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DeliveryAppointment do
  #let(:instance) { SimplebillyApi::DeliveryAppointment.new }

  describe 'test an instance of DeliveryAppointment' do
    it 'should create an instance of DeliveryAppointment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DeliveryAppointment)
    end
  end

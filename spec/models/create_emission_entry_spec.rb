...
# Unit tests for SimplebillyApi::CreateEmissionEntry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CreateEmissionEntry do
  #let(:instance) { SimplebillyApi::CreateEmissionEntry.new }

  describe 'test an instance of CreateEmissionEntry' do
    it 'should create an instance of CreateEmissionEntry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CreateEmissionEntry)
    end
  end

...
# Unit tests for SimplebillyApi::LanguageCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::LanguageCode do
  #let(:instance) { SimplebillyApi::LanguageCode.new }

  describe 'test an instance of LanguageCode' do
    it 'should create an instance of LanguageCode' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::LanguageCode)
    end
  end

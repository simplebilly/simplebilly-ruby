...
# Unit tests for SimplebillyApi::Package
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Package do
  #let(:instance) { SimplebillyApi::Package.new }

  describe 'test an instance of Package' do
    it 'should create an instance of Package' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Package)
    end
  end

...
# Unit tests for SimplebillyApi::Customer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Customer do
  #let(:instance) { SimplebillyApi::Customer.new }

  describe 'test an instance of Customer' do
    it 'should create an instance of Customer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Customer)
    end
  end

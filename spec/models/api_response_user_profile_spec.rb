...
# Unit tests for SimplebillyApi::ApiResponseUserProfile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApiResponseUserProfile do
  #let(:instance) { SimplebillyApi::ApiResponseUserProfile.new }

  describe 'test an instance of ApiResponseUserProfile' do
    it 'should create an instance of ApiResponseUserProfile' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApiResponseUserProfile)
    end
  end

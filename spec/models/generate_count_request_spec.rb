...
# Unit tests for SimplebillyApi::GenerateCountRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GenerateCountRequest do
  #let(:instance) { SimplebillyApi::GenerateCountRequest.new }

  describe 'test an instance of GenerateCountRequest' do
    it 'should create an instance of GenerateCountRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GenerateCountRequest)
    end
  end

...
# Unit tests for SimplebillyApi::EmailTemplateStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmailTemplateStatus do
  #let(:instance) { SimplebillyApi::EmailTemplateStatus.new }

  describe 'test an instance of EmailTemplateStatus' do
    it 'should create an instance of EmailTemplateStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmailTemplateStatus)
    end
  end

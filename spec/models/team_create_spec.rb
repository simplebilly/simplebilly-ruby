...
# Unit tests for SimplebillyApi::TeamCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TeamCreate do
  #let(:instance) { SimplebillyApi::TeamCreate.new }

  describe 'test an instance of TeamCreate' do
    it 'should create an instance of TeamCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TeamCreate)
    end
  end

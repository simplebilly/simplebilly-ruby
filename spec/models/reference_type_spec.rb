...
# Unit tests for SimplebillyApi::ReferenceType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ReferenceType do
  #let(:instance) { SimplebillyApi::ReferenceType.new }

  describe 'test an instance of ReferenceType' do
    it 'should create an instance of ReferenceType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ReferenceType)
    end
  end

...
# Unit tests for SimplebillyApi::AutomationDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::AutomationDto do
  #let(:instance) { SimplebillyApi::AutomationDto.new }

  describe 'test an instance of AutomationDto' do
    it 'should create an instance of AutomationDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::AutomationDto)
    end
  end

  describe 'test attribute "automation_key"' do
    it 'should work' do
  ...
  describe 'test attribute "default_day"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "schedule_kind"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

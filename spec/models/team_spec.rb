...
# Unit tests for SimplebillyApi::Team
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Team do
  #let(:instance) { SimplebillyApi::Team.new }

  describe 'test an instance of Team' do
    it 'should create an instance of Team' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Team)
    end
  end

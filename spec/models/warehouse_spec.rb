...
# Unit tests for SimplebillyApi::Warehouse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Warehouse do
  #let(:instance) { SimplebillyApi::Warehouse.new }

  describe 'test an instance of Warehouse' do
    it 'should create an instance of Warehouse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Warehouse)
    end
  end

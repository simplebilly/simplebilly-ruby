...
# Unit tests for SimplebillyApi::DocumentType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DocumentType do
  #let(:instance) { SimplebillyApi::DocumentType.new }

  describe 'test an instance of DocumentType' do
    it 'should create an instance of DocumentType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DocumentType)
    end
  end

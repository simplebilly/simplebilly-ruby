...
# Unit tests for SimplebillyApi::UpdateTenantSettings
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::UpdateTenantSettings do
  #let(:instance) { SimplebillyApi::UpdateTenantSettings.new }

  describe 'test an instance of UpdateTenantSettings' do
    it 'should create an instance of UpdateTenantSettings' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::UpdateTenantSettings)
    end
  end

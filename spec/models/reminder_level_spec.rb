...
# Unit tests for SimplebillyApi::ReminderLevel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ReminderLevel do
  #let(:instance) { SimplebillyApi::ReminderLevel.new }

  describe 'test an instance of ReminderLevel' do
    it 'should create an instance of ReminderLevel' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ReminderLevel)
    end
  end

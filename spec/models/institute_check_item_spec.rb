...
# Unit tests for SimplebillyApi::InstituteCheckItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::InstituteCheckItem do
  #let(:instance) { SimplebillyApi::InstituteCheckItem.new }

  describe 'test an instance of InstituteCheckItem' do
    it 'should create an instance of InstituteCheckItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::InstituteCheckItem)
    end
  end

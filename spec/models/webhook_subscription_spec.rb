...
# Unit tests for SimplebillyApi::WebhookSubscription
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::WebhookSubscription do
  #let(:instance) { SimplebillyApi::WebhookSubscription.new }

  describe 'test an instance of WebhookSubscription' do
    it 'should create an instance of WebhookSubscription' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::WebhookSubscription)
    end
  end

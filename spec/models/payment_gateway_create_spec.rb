...
# Unit tests for SimplebillyApi::PaymentGatewayCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PaymentGatewayCreate do
  #let(:instance) { SimplebillyApi::PaymentGatewayCreate.new }

  describe 'test an instance of PaymentGatewayCreate' do
    it 'should create an instance of PaymentGatewayCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PaymentGatewayCreate)
    end
  end

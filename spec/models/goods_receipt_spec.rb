...
# Unit tests for SimplebillyApi::GoodsReceipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GoodsReceipt do
  #let(:instance) { SimplebillyApi::GoodsReceipt.new }

  describe 'test an instance of GoodsReceipt' do
    it 'should create an instance of GoodsReceipt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GoodsReceipt)
    end
  end

  describe 'test attribute "gr_number"' do
    it 'should work' do
  ...
  describe 'test attribute "receipt_date"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

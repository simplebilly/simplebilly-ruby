...
# Unit tests for SimplebillyApi::LegalDocType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::LegalDocType do
  #let(:instance) { SimplebillyApi::LegalDocType.new }

  describe 'test an instance of LegalDocType' do
    it 'should create an instance of LegalDocType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::LegalDocType)
    end
  end

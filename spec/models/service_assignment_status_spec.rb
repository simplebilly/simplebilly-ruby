...
# Unit tests for SimplebillyApi::ServiceAssignmentStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ServiceAssignmentStatus do
  #let(:instance) { SimplebillyApi::ServiceAssignmentStatus.new }

  describe 'test an instance of ServiceAssignmentStatus' do
    it 'should create an instance of ServiceAssignmentStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ServiceAssignmentStatus)
    end
  end

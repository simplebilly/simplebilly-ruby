...
# Unit tests for SimplebillyApi::WarehouseStock
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::WarehouseStock do
  #let(:instance) { SimplebillyApi::WarehouseStock.new }

  describe 'test an instance of WarehouseStock' do
    it 'should create an instance of WarehouseStock' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::WarehouseStock)
    end
  end

...
# Unit tests for SimplebillyApi::ImportJobStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ImportJobStatus do
  #let(:instance) { SimplebillyApi::ImportJobStatus.new }

  describe 'test an instance of ImportJobStatus' do
    it 'should create an instance of ImportJobStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ImportJobStatus)
    end
  end

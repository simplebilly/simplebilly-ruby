...
# Unit tests for SimplebillyApi::SyncType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SyncType do
  #let(:instance) { SimplebillyApi::SyncType.new }

  describe 'test an instance of SyncType' do
    it 'should create an instance of SyncType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SyncType)
    end
  end

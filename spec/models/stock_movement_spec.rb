...
# Unit tests for SimplebillyApi::StockMovement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::StockMovement do
  #let(:instance) { SimplebillyApi::StockMovement.new }

  describe 'test an instance of StockMovement' do
    it 'should create an instance of StockMovement' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::StockMovement)
    end
  end

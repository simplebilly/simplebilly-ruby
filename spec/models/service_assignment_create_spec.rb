...
# Unit tests for SimplebillyApi::ServiceAssignmentCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ServiceAssignmentCreate do
  #let(:instance) { SimplebillyApi::ServiceAssignmentCreate.new }

  describe 'test an instance of ServiceAssignmentCreate' do
    it 'should create an instance of ServiceAssignmentCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ServiceAssignmentCreate)
    end
  end

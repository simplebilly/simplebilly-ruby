...
# Unit tests for SimplebillyApi::UpdateSubscriptionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::UpdateSubscriptionRequest do
  #let(:instance) { SimplebillyApi::UpdateSubscriptionRequest.new }
  ...
  describe 'test an instance of UpdateSubscriptionRequest' do
    it 'should create an instance of UpdateSubscriptionRequest' do
      ...
      #expect(instance).to be_instance_of(SimplebillyApi::UpdateSubscriptionRequest)
    end
  end

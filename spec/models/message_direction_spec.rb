...
# Unit tests for SimplebillyApi::MessageDirection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::MessageDirection do
  #let(:instance) { SimplebillyApi::MessageDirection.new }

  describe 'test an instance of MessageDirection' do
    it 'should create an instance of MessageDirection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::MessageDirection)
    end
  end

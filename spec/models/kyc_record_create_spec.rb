...
# Unit tests for SimplebillyApi::KycRecordCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::KycRecordCreate do
  #let(:instance) { SimplebillyApi::KycRecordCreate.new }

  describe 'test an instance of KycRecordCreate' do
    it 'should create an instance of KycRecordCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::KycRecordCreate)
    end
  end

...
# Unit tests for SimplebillyApi::PluginErrorOneOf3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PluginErrorOneOf3 do
  #let(:instance) { SimplebillyApi::PluginErrorOneOf3.new }

  describe 'test an instance of PluginErrorOneOf3' do
    it 'should create an instance of PluginErrorOneOf3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PluginErrorOneOf3)
    end
  end

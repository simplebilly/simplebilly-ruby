...
# Unit tests for SimplebillyApi::EmitEventRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmitEventRequest do
  #let(:instance) { SimplebillyApi::EmitEventRequest.new }

  describe 'test an instance of EmitEventRequest' do
    it 'should create an instance of EmitEventRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmitEventRequest)
    end
  end

...
# Unit tests for SimplebillyApi::RecurringTemplateType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::RecurringTemplateType do
  #let(:instance) { SimplebillyApi::RecurringTemplateType.new }

  describe 'test an instance of RecurringTemplateType' do
    it 'should create an instance of RecurringTemplateType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::RecurringTemplateType)
    end
  end

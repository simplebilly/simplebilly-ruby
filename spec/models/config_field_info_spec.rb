...
# Unit tests for SimplebillyApi::ConfigFieldInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ConfigFieldInfo do
  #let(:instance) { SimplebillyApi::ConfigFieldInfo.new }

  describe 'test an instance of ConfigFieldInfo' do
    it 'should create an instance of ConfigFieldInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ConfigFieldInfo)
    end
  end

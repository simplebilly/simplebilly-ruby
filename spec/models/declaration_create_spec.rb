...
# Unit tests for SimplebillyApi::DeclarationCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DeclarationCreate do
  #let(:instance) { SimplebillyApi::DeclarationCreate.new }

  describe 'test an instance of DeclarationCreate' do
    it 'should create an instance of DeclarationCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DeclarationCreate)
    end
  end

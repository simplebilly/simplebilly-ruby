...
# Unit tests for SimplebillyApi::AbsenceCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::AbsenceCreate do
  #let(:instance) { SimplebillyApi::AbsenceCreate.new }

  describe 'test an instance of AbsenceCreate' do
    it 'should create an instance of AbsenceCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::AbsenceCreate)
    end
  end

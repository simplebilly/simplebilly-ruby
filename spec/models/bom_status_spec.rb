...
# Unit tests for SimplebillyApi::BomStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::BomStatus do
  #let(:instance) { SimplebillyApi::BomStatus.new }

  describe 'test an instance of BomStatus' do
    it 'should create an instance of BomStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::BomStatus)
    end
  end

...
# Unit tests for SimplebillyApi::OssDependency
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OssDependency do
  #let(:instance) { SimplebillyApi::OssDependency.new }

  describe 'test an instance of OssDependency' do
    it 'should create an instance of OssDependency' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OssDependency)
    end
  end

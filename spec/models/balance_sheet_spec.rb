...
# Unit tests for SimplebillyApi::BalanceSheet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::BalanceSheet do
  #let(:instance) { SimplebillyApi::BalanceSheet.new }

  describe 'test an instance of BalanceSheet' do
    it 'should create an instance of BalanceSheet' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::BalanceSheet)
    end
  end
  ...
  describe 'test attribute "equity_liabilities"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "total_equity_liabilities"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

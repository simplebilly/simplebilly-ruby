...
# Unit tests for SimplebillyApi::PosTableStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PosTableStatus do
  #let(:instance) { SimplebillyApi::PosTableStatus.new }

  describe 'test an instance of PosTableStatus' do
    it 'should create an instance of PosTableStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PosTableStatus)
    end
  end

...
# Unit tests for SimplebillyApi::OAuthAuthorizeRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OAuthAuthorizeRequest do
  #let(:instance) { SimplebillyApi::OAuthAuthorizeRequest.new }

  describe 'test an instance of OAuthAuthorizeRequest' do
    it 'should create an instance of OAuthAuthorizeRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OAuthAuthorizeRequest)
    end
  end

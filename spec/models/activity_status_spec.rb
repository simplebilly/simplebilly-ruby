...
# Unit tests for SimplebillyApi::ActivityStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ActivityStatus do
  #let(:instance) { SimplebillyApi::ActivityStatus.new }

  describe 'test an instance of ActivityStatus' do
    it 'should create an instance of ActivityStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ActivityStatus)
    end
  end

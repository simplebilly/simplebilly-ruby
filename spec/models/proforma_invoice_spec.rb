...
# Unit tests for SimplebillyApi::ProformaInvoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProformaInvoice do
  #let(:instance) { SimplebillyApi::ProformaInvoice.new }

  describe 'test an instance of ProformaInvoice' do
    it 'should create an instance of ProformaInvoice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProformaInvoice)
    end
  end

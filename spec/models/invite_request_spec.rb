...
# Unit tests for SimplebillyApi::InviteRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::InviteRequest do
  #let(:instance) { SimplebillyApi::InviteRequest.new }

  describe 'test an instance of InviteRequest' do
    it 'should create an instance of InviteRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::InviteRequest)
    end
  end

...
# Unit tests for SimplebillyApi::EmissionMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EmissionMethod do
  #let(:instance) { SimplebillyApi::EmissionMethod.new }

  describe 'test an instance of EmissionMethod' do
    it 'should create an instance of EmissionMethod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EmissionMethod)
    end
  end

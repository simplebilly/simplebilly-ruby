...
# Unit tests for SimplebillyApi::SupplierInvoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SupplierInvoice do
  #let(:instance) { SimplebillyApi::SupplierInvoice.new }

  describe 'test an instance of SupplierInvoice' do
    it 'should create an instance of SupplierInvoice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SupplierInvoice)
    end
  end

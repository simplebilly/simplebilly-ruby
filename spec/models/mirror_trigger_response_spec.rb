...
# Unit tests for SimplebillyApi::MirrorTriggerResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::MirrorTriggerResponse do
  #let(:instance) { SimplebillyApi::MirrorTriggerResponse.new }

  describe 'test an instance of MirrorTriggerResponse' do
    it 'should create an instance of MirrorTriggerResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::MirrorTriggerResponse)
    end
  end

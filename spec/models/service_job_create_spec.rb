...
# Unit tests for SimplebillyApi::ServiceJobCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ServiceJobCreate do
  #let(:instance) { SimplebillyApi::ServiceJobCreate.new }

  describe 'test an instance of ServiceJobCreate' do
    it 'should create an instance of ServiceJobCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ServiceJobCreate)
    end
  end

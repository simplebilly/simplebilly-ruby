...
# Unit tests for SimplebillyApi::GuVReport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GuVReport do
  #let(:instance) { SimplebillyApi::GuVReport.new }

  describe 'test an instance of GuVReport' do
    it 'should create an instance of GuVReport' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GuVReport)
    end
  end

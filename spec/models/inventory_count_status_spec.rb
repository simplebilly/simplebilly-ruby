...
# Unit tests for SimplebillyApi::InventoryCountStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::InventoryCountStatus do
  #let(:instance) { SimplebillyApi::InventoryCountStatus.new }

  describe 'test an instance of InventoryCountStatus' do
    it 'should create an instance of InventoryCountStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::InventoryCountStatus)
    end
  end

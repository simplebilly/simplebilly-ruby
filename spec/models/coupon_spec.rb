...
# Unit tests for SimplebillyApi::Coupon
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Coupon do
  #let(:instance) { SimplebillyApi::Coupon.new }

  describe 'test an instance of Coupon' do
    it 'should create an instance of Coupon' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Coupon)
    end
  end

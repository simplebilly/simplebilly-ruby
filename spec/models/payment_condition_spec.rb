...
# Unit tests for SimplebillyApi::PaymentCondition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PaymentCondition do
  #let(:instance) { SimplebillyApi::PaymentCondition.new }

  describe 'test an instance of PaymentCondition' do
    it 'should create an instance of PaymentCondition' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PaymentCondition)
    end
  end

...
# Unit tests for SimplebillyApi::ImportStartRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ImportStartRequest do
  #let(:instance) { SimplebillyApi::ImportStartRequest.new }

  describe 'test an instance of ImportStartRequest' do
    it 'should create an instance of ImportStartRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ImportStartRequest)
    end
  end

...
# Unit tests for SimplebillyApi::BankLookup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::BankLookup do
  #let(:instance) { SimplebillyApi::BankLookup.new }

  describe 'test an instance of BankLookup' do
    it 'should create an instance of BankLookup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::BankLookup)
    end
  end
  ...
  describe 'test attribute "nextgenpsd2_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "psd2_supported"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

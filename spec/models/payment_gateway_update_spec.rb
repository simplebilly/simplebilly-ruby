...
# Unit tests for SimplebillyApi::PaymentGatewayUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PaymentGatewayUpdate do
  #let(:instance) { SimplebillyApi::PaymentGatewayUpdate.new }

  describe 'test an instance of PaymentGatewayUpdate' do
    it 'should create an instance of PaymentGatewayUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PaymentGatewayUpdate)
    end
  end

...
# Unit tests for SimplebillyApi::XRechnungResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::XRechnungResponse do
  #let(:instance) { SimplebillyApi::XRechnungResponse.new }

  describe 'test an instance of XRechnungResponse' do
    it 'should create an instance of XRechnungResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::XRechnungResponse)
    end
  end

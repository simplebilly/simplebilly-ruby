...
# Unit tests for SimplebillyApi::QuotaOverride
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::QuotaOverride do
  #let(:instance) { SimplebillyApi::QuotaOverride.new }

  describe 'test an instance of QuotaOverride' do
    it 'should create an instance of QuotaOverride' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::QuotaOverride)
    end
  end

...
# Unit tests for SimplebillyApi::ApiResponseVecPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApiResponseVecPlan do
  #let(:instance) { SimplebillyApi::ApiResponseVecPlan.new }

  describe 'test an instance of ApiResponseVecPlan' do
    it 'should create an instance of ApiResponseVecPlan' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApiResponseVecPlan)
    end
  end

...
# Unit tests for SimplebillyApi::PayGapExportResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PayGapExportResponse do
  #let(:instance) { SimplebillyApi::PayGapExportResponse.new }

  describe 'test an instance of PayGapExportResponse' do
    it 'should create an instance of PayGapExportResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PayGapExportResponse)
    end
  end

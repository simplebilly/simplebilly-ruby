...
# Unit tests for SimplebillyApi::InventoryCountUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::InventoryCountUpdate do
  #let(:instance) { SimplebillyApi::InventoryCountUpdate.new }

  describe 'test an instance of InventoryCountUpdate' do
    it 'should create an instance of InventoryCountUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::InventoryCountUpdate)
    end
  end

...
# Unit tests for SimplebillyApi::OAuthCallbackRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OAuthCallbackRequest do
  #let(:instance) { SimplebillyApi::OAuthCallbackRequest.new }

  describe 'test an instance of OAuthCallbackRequest' do
    it 'should create an instance of OAuthCallbackRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OAuthCallbackRequest)
    end
  end

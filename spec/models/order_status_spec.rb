...
# Unit tests for SimplebillyApi::OrderStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OrderStatus do
  #let(:instance) { SimplebillyApi::OrderStatus.new }

  describe 'test an instance of OrderStatus' do
    it 'should create an instance of OrderStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OrderStatus)
    end
  end

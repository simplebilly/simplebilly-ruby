...
# Unit tests for SimplebillyApi::RfqStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::RfqStatus do
  #let(:instance) { SimplebillyApi::RfqStatus.new }

  describe 'test an instance of RfqStatus' do
    it 'should create an instance of RfqStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::RfqStatus)
    end
  end

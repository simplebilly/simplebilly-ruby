...
# Unit tests for SimplebillyApi::DeclarationType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DeclarationType do
  #let(:instance) { SimplebillyApi::DeclarationType.new }

  describe 'test an instance of DeclarationType' do
    it 'should create an instance of DeclarationType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DeclarationType)
    end
  end

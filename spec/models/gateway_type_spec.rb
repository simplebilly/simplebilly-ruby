...
# Unit tests for SimplebillyApi::GatewayType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GatewayType do
  #let(:instance) { SimplebillyApi::GatewayType.new }

  describe 'test an instance of GatewayType' do
    it 'should create an instance of GatewayType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GatewayType)
    end
  end

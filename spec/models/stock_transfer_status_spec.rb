...
# Unit tests for SimplebillyApi::StockTransferStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::StockTransferStatus do
  #let(:instance) { SimplebillyApi::StockTransferStatus.new }

  describe 'test an instance of StockTransferStatus' do
    it 'should create an instance of StockTransferStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::StockTransferStatus)
    end
  end

...
# Unit tests for SimplebillyApi::ApiResponseGdprExportData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApiResponseGdprExportData do
  #let(:instance) { SimplebillyApi::ApiResponseGdprExportData.new }

  describe 'test an instance of ApiResponseGdprExportData' do
    it 'should create an instance of ApiResponseGdprExportData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApiResponseGdprExportData)
    end
  end
  ...
  describe 'test attribute "generated_by_ai"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::LegalDocumentUpsert
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::LegalDocumentUpsert do
  #let(:instance) { SimplebillyApi::LegalDocumentUpsert.new }

  describe 'test an instance of LegalDocumentUpsert' do
    it 'should create an instance of LegalDocumentUpsert' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::LegalDocumentUpsert)
    end
  end

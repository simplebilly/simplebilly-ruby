...
# Unit tests for SimplebillyApi::WebhookEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::WebhookEvent do
  #let(:instance) { SimplebillyApi::WebhookEvent.new }

  describe 'test an instance of WebhookEvent' do
    it 'should create an instance of WebhookEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::WebhookEvent)
    end
  end

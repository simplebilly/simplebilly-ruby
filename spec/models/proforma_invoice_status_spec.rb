...
# Unit tests for SimplebillyApi::ProformaInvoiceStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProformaInvoiceStatus do
  #let(:instance) { SimplebillyApi::ProformaInvoiceStatus.new }

  describe 'test an instance of ProformaInvoiceStatus' do
    it 'should create an instance of ProformaInvoiceStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProformaInvoiceStatus)
    end
  end

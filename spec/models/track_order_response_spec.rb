...
# Unit tests for SimplebillyApi::TrackOrderResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TrackOrderResponse do
  #let(:instance) { SimplebillyApi::TrackOrderResponse.new }

  describe 'test an instance of TrackOrderResponse' do
    it 'should create an instance of TrackOrderResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TrackOrderResponse)
    end
  end

...
# Unit tests for SimplebillyApi::SupplierInvoiceStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SupplierInvoiceStatus do
  #let(:instance) { SimplebillyApi::SupplierInvoiceStatus.new }

  describe 'test an instance of SupplierInvoiceStatus' do
    it 'should create an instance of SupplierInvoiceStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SupplierInvoiceStatus)
    end
  end

...
# Unit tests for SimplebillyApi::Participation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Participation do
  #let(:instance) { SimplebillyApi::Participation.new }

  describe 'test an instance of Participation' do
    it 'should create an instance of Participation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Participation)
    end
  end

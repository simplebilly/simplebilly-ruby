...
# Unit tests for SimplebillyApi::SmtpEncryption
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SmtpEncryption do
  #let(:instance) { SimplebillyApi::SmtpEncryption.new }

  describe 'test an instance of SmtpEncryption' do
    it 'should create an instance of SmtpEncryption' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SmtpEncryption)
    end
  end

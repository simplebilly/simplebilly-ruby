...
# Unit tests for SimplebillyApi::Automation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Automation do
  #let(:instance) { SimplebillyApi::Automation.new }

  describe 'test an instance of Automation' do
    it 'should create an instance of Automation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Automation)
    end
  end

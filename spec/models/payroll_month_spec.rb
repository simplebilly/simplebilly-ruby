...
# Unit tests for SimplebillyApi::PayrollMonth
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PayrollMonth do
  #let(:instance) { SimplebillyApi::PayrollMonth.new }

  describe 'test an instance of PayrollMonth' do
    it 'should create an instance of PayrollMonth' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PayrollMonth)
    end
  end

...
# Unit tests for SimplebillyApi::InvoiceType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::InvoiceType do
  #let(:instance) { SimplebillyApi::InvoiceType.new }

  describe 'test an instance of InvoiceType' do
    it 'should create an instance of InvoiceType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::InvoiceType)
    end
  end

...
# Unit tests for SimplebillyApi::ProductionOrder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProductionOrder do
  #let(:instance) { SimplebillyApi::ProductionOrder.new }

  describe 'test an instance of ProductionOrder' do
    it 'should create an instance of ProductionOrder' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProductionOrder)
    end
  end

  describe 'test attribute "bom_id"' do
    it 'should work' do

...
# Unit tests for SimplebillyApi::PlausibilitySummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PlausibilitySummary do
  #let(:instance) { SimplebillyApi::PlausibilitySummary.new }

  describe 'test an instance of PlausibilitySummary' do
    it 'should create an instance of PlausibilitySummary' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PlausibilitySummary)
    end
  end

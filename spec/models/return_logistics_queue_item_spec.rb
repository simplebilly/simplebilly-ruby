...
# Unit tests for SimplebillyApi::ReturnLogisticsQueueItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ReturnLogisticsQueueItem do
  #let(:instance) { SimplebillyApi::ReturnLogisticsQueueItem.new }

  describe 'test an instance of ReturnLogisticsQueueItem' do
    it 'should create an instance of ReturnLogisticsQueueItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ReturnLogisticsQueueItem)
    end
  end

...
# Unit tests for SimplebillyApi::DeliveryDate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DeliveryDate do
  #let(:instance) { SimplebillyApi::DeliveryDate.new }

  describe 'test an instance of DeliveryDate' do
    it 'should create an instance of DeliveryDate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DeliveryDate)
    end
  end

...
# Unit tests for SimplebillyApi::PayrollRunStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PayrollRunStatus do
  #let(:instance) { SimplebillyApi::PayrollRunStatus.new }

  describe 'test an instance of PayrollRunStatus' do
    it 'should create an instance of PayrollRunStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PayrollRunStatus)
    end
  end

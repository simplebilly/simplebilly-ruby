...
# Unit tests for SimplebillyApi::Absence
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Absence do
  #let(:instance) { SimplebillyApi::Absence.new }

  describe 'test an instance of Absence' do
    it 'should create an instance of Absence' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Absence)
    end
  end

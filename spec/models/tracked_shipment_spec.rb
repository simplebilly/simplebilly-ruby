...
# Unit tests for SimplebillyApi::TrackedShipment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TrackedShipment do
  #let(:instance) { SimplebillyApi::TrackedShipment.new }

  describe 'test an instance of TrackedShipment' do
    it 'should create an instance of TrackedShipment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TrackedShipment)
    end
  end

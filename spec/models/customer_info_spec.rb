...
# Unit tests for SimplebillyApi::CustomerInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CustomerInfo do
  #let(:instance) { SimplebillyApi::CustomerInfo.new }

  describe 'test an instance of CustomerInfo' do
    it 'should create an instance of CustomerInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CustomerInfo)
    end
  end

  describe 'test attribute "annual_volume"' do
    it 'should work' do

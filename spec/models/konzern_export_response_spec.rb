...
# Unit tests for SimplebillyApi::KonzernExportResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::KonzernExportResponse do
  #let(:instance) { SimplebillyApi::KonzernExportResponse.new }

  describe 'test an instance of KonzernExportResponse' do
    it 'should create an instance of KonzernExportResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::KonzernExportResponse)
    end
  end

...
# Unit tests for SimplebillyApi::RevenueItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::RevenueItem do
  #let(:instance) { SimplebillyApi::RevenueItem.new }

  describe 'test an instance of RevenueItem' do
    it 'should create an instance of RevenueItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::RevenueItem)
    end
  end

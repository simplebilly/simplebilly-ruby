...
# Unit tests for SimplebillyApi::SepaDirectDebitResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SepaDirectDebitResponse do
  #let(:instance) { SimplebillyApi::SepaDirectDebitResponse.new }

  describe 'test an instance of SepaDirectDebitResponse' do
    it 'should create an instance of SepaDirectDebitResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SepaDirectDebitResponse)
    end
  end

...
# Unit tests for SimplebillyApi::UserTenantInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::UserTenantInfo do
  #let(:instance) { SimplebillyApi::UserTenantInfo.new }

  describe 'test an instance of UserTenantInfo' do
    it 'should create an instance of UserTenantInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::UserTenantInfo)
    end
  end

...
# Unit tests for SimplebillyApi::CompanyType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CompanyType do
  #let(:instance) { SimplebillyApi::CompanyType.new }

  describe 'test an instance of CompanyType' do
    it 'should create an instance of CompanyType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CompanyType)
    end
  end

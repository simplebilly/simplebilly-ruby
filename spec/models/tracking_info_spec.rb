...
# Unit tests for SimplebillyApi::TrackingInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TrackingInfo do
  #let(:instance) { SimplebillyApi::TrackingInfo.new }

  describe 'test an instance of TrackingInfo' do
    it 'should create an instance of TrackingInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TrackingInfo)
    end
  end

...
# Unit tests for SimplebillyApi::PluginErrorOneOf2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PluginErrorOneOf2 do
  #let(:instance) { SimplebillyApi::PluginErrorOneOf2.new }

  describe 'test an instance of PluginErrorOneOf2' do
    it 'should create an instance of PluginErrorOneOf2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PluginErrorOneOf2)
    end
  end

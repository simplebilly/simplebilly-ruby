...
# Unit tests for SimplebillyApi::DpaStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DpaStatus do
  #let(:instance) { SimplebillyApi::DpaStatus.new }

  describe 'test an instance of DpaStatus' do
    it 'should create an instance of DpaStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DpaStatus)
    end
  end

...
# Unit tests for SimplebillyApi::TicketMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TicketMessage do
  #let(:instance) { SimplebillyApi::TicketMessage.new }

  describe 'test an instance of TicketMessage' do
    it 'should create an instance of TicketMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TicketMessage)
    end
  end

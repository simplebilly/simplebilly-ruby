...
# Unit tests for SimplebillyApi::BudgetGoalRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::BudgetGoalRequest do
  #let(:instance) { SimplebillyApi::BudgetGoalRequest.new }

  describe 'test an instance of BudgetGoalRequest' do
    it 'should create an instance of BudgetGoalRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::BudgetGoalRequest)
    end
  end

...
# Unit tests for SimplebillyApi::KycRecordUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::KycRecordUpdate do
  #let(:instance) { SimplebillyApi::KycRecordUpdate.new }

  describe 'test an instance of KycRecordUpdate' do
    it 'should create an instance of KycRecordUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::KycRecordUpdate)
    end
  end
  ...
  describe 'test attribute "kyc_date"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "retention_until"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for SimplebillyApi::TrainingSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TrainingSource do
  #let(:instance) { SimplebillyApi::TrainingSource.new }

  describe 'test an instance of TrainingSource' do
    it 'should create an instance of TrainingSource' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TrainingSource)
    end
  end

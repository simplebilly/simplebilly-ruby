...
# Unit tests for SimplebillyApi::CostingLine
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CostingLine do
  #let(:instance) { SimplebillyApi::CostingLine.new }

  describe 'test an instance of CostingLine' do
    it 'should create an instance of CostingLine' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CostingLine)
    end
  end

  describe 'test attribute "line_cost"' do
    it 'should work' do
  ...
  describe 'test attribute "quantity_per_unit"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "unit_purchase_price"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

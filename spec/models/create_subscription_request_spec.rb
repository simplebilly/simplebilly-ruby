...
# Unit tests for SimplebillyApi::CreateSubscriptionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CreateSubscriptionRequest do
  #let(:instance) { SimplebillyApi::CreateSubscriptionRequest.new }
  ...
  describe 'test an instance of CreateSubscriptionRequest' do
    it 'should create an instance of CreateSubscriptionRequest' do
      ...
      #expect(instance).to be_instance_of(SimplebillyApi::CreateSubscriptionRequest)
    end
  end

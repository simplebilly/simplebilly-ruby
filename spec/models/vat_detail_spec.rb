...
# Unit tests for SimplebillyApi::VatDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::VatDetail do
  #let(:instance) { SimplebillyApi::VatDetail.new }

  describe 'test an instance of VatDetail' do
    it 'should create an instance of VatDetail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::VatDetail)
    end
  end

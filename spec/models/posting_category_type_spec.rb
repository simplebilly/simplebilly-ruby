...
# Unit tests for SimplebillyApi::PostingCategoryType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PostingCategoryType do
  #let(:instance) { SimplebillyApi::PostingCategoryType.new }

  describe 'test an instance of PostingCategoryType' do
    it 'should create an instance of PostingCategoryType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PostingCategoryType)
    end
  end

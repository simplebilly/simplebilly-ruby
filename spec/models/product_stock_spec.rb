...
# Unit tests for SimplebillyApi::ProductStock
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProductStock do
  #let(:instance) { SimplebillyApi::ProductStock.new }

  describe 'test an instance of ProductStock' do
    it 'should create an instance of ProductStock' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProductStock)
    end
  end

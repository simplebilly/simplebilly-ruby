...
# Unit tests for SimplebillyApi::QRCodeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::QRCodeResponse do
  #let(:instance) { SimplebillyApi::QRCodeResponse.new }

  describe 'test an instance of QRCodeResponse' do
    it 'should create an instance of QRCodeResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::QRCodeResponse)
    end
  end
  ...
  describe 'test attribute "qr_code_base64"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

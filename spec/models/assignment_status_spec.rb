...
# Unit tests for SimplebillyApi::AssignmentStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::AssignmentStatus do
  #let(:instance) { SimplebillyApi::AssignmentStatus.new }

  describe 'test an instance of AssignmentStatus' do
    it 'should create an instance of AssignmentStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::AssignmentStatus)
    end
  end

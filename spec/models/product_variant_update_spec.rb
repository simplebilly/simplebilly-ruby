...
# Unit tests for SimplebillyApi::ProductVariantUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProductVariantUpdate do
  #let(:instance) { SimplebillyApi::ProductVariantUpdate.new }

  describe 'test an instance of ProductVariantUpdate' do
    it 'should create an instance of ProductVariantUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProductVariantUpdate)
    end
  end

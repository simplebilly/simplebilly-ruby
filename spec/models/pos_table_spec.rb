...
# Unit tests for SimplebillyApi::PosTable
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PosTable do
  #let(:instance) { SimplebillyApi::PosTable.new }

  describe 'test an instance of PosTable' do
    it 'should create an instance of PosTable' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PosTable)
    end
  end

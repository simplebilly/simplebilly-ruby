...
# Unit tests for SimplebillyApi::TicketPriority
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TicketPriority do
  #let(:instance) { SimplebillyApi::TicketPriority.new }

  describe 'test an instance of TicketPriority' do
    it 'should create an instance of TicketPriority' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TicketPriority)
    end
  end

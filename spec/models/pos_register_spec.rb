...
# Unit tests for SimplebillyApi::PosRegister
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PosRegister do
  #let(:instance) { SimplebillyApi::PosRegister.new }

  describe 'test an instance of PosRegister' do
    it 'should create an instance of PosRegister' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PosRegister)
    end
  end

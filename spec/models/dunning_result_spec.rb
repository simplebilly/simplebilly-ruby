...
# Unit tests for SimplebillyApi::DunningResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DunningResult do
  #let(:instance) { SimplebillyApi::DunningResult.new }

  describe 'test an instance of DunningResult' do
    it 'should create an instance of DunningResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DunningResult)
    end
  end

  describe 'test attribute "invoices_processed"' do
    it 'should work' do

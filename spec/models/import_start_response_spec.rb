...
# Unit tests for SimplebillyApi::ImportStartResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ImportStartResponse do
  #let(:instance) { SimplebillyApi::ImportStartResponse.new }

  describe 'test an instance of ImportStartResponse' do
    it 'should create an instance of ImportStartResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ImportStartResponse)
    end
  end

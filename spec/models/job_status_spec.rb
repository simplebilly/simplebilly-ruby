...
# Unit tests for SimplebillyApi::JobStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::JobStatus do
  #let(:instance) { SimplebillyApi::JobStatus.new }

  describe 'test an instance of JobStatus' do
    it 'should create an instance of JobStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::JobStatus)
    end
  end

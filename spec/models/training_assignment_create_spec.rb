...
# Unit tests for SimplebillyApi::TrainingAssignmentCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TrainingAssignmentCreate do
  #let(:instance) { SimplebillyApi::TrainingAssignmentCreate.new }

  describe 'test an instance of TrainingAssignmentCreate' do
    it 'should create an instance of TrainingAssignmentCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TrainingAssignmentCreate)
    end
  end

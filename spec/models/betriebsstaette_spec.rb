...
# Unit tests for SimplebillyApi::Betriebsstaette
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Betriebsstaette do
  #let(:instance) { SimplebillyApi::Betriebsstaette.new }

  describe 'test an instance of Betriebsstaette' do
    it 'should create an instance of Betriebsstaette' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Betriebsstaette)
    end
  end

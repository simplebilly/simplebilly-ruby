...
# Unit tests for SimplebillyApi::StilleReport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::StilleReport do
  #let(:instance) { SimplebillyApi::StilleReport.new }

  describe 'test an instance of StilleReport' do
    it 'should create an instance of StilleReport' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::StilleReport)
    end
  end

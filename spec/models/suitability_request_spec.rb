...
# Unit tests for SimplebillyApi::SuitabilityRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SuitabilityRequest do
  #let(:instance) { SimplebillyApi::SuitabilityRequest.new }

  describe 'test an instance of SuitabilityRequest' do
    it 'should create an instance of SuitabilityRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SuitabilityRequest)
    end
  end

  describe 'test attribute "customer_annual_volume"' do
    it 'should work' do

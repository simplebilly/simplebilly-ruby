...
# Unit tests for SimplebillyApi::JobPosting
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::JobPosting do
  #let(:instance) { SimplebillyApi::JobPosting.new }

  describe 'test an instance of JobPosting' do
    it 'should create an instance of JobPosting' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::JobPosting)
    end
  end

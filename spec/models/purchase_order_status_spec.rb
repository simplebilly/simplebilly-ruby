...
# Unit tests for SimplebillyApi::PurchaseOrderStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PurchaseOrderStatus do
  #let(:instance) { SimplebillyApi::PurchaseOrderStatus.new }

  describe 'test an instance of PurchaseOrderStatus' do
    it 'should create an instance of PurchaseOrderStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PurchaseOrderStatus)
    end
  end

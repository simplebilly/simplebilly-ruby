...
# Unit tests for SimplebillyApi::ReorderProposalResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ReorderProposalResponse do
  #let(:instance) { SimplebillyApi::ReorderProposalResponse.new }

  describe 'test an instance of ReorderProposalResponse' do
    it 'should create an instance of ReorderProposalResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ReorderProposalResponse)
    end
  end

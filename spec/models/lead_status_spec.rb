...
# Unit tests for SimplebillyApi::LeadStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::LeadStatus do
  #let(:instance) { SimplebillyApi::LeadStatus.new }

  describe 'test an instance of LeadStatus' do
    it 'should create an instance of LeadStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::LeadStatus)
    end
  end

...
# Unit tests for SimplebillyApi::ActivityType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ActivityType do
  #let(:instance) { SimplebillyApi::ActivityType.new }

  describe 'test an instance of ActivityType' do
    it 'should create an instance of ActivityType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ActivityType)
    end
  end

...
# Unit tests for SimplebillyApi::ResolvedPriceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ResolvedPriceResponse do
  #let(:instance) { SimplebillyApi::ResolvedPriceResponse.new }

  describe 'test an instance of ResolvedPriceResponse' do
    it 'should create an instance of ResolvedPriceResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ResolvedPriceResponse)
    end
  end

  describe 'test attribute "is_list_price"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "price_tier_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

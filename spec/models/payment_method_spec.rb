...
# Unit tests for SimplebillyApi::PaymentMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PaymentMethod do
  #let(:instance) { SimplebillyApi::PaymentMethod.new }

  describe 'test an instance of PaymentMethod' do
    it 'should create an instance of PaymentMethod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PaymentMethod)
    end
  end

...
# Unit tests for SimplebillyApi::ApiResponseGdprExport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApiResponseGdprExport do
  #let(:instance) { SimplebillyApi::ApiResponseGdprExport.new }

  describe 'test an instance of ApiResponseGdprExport' do
    it 'should create an instance of ApiResponseGdprExport' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApiResponseGdprExport)
    end
  end

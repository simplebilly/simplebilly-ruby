...
# Unit tests for SimplebillyApi::ProductAttributeCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProductAttributeCreate do
  #let(:instance) { SimplebillyApi::ProductAttributeCreate.new }

  describe 'test an instance of ProductAttributeCreate' do
    it 'should create an instance of ProductAttributeCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProductAttributeCreate)
    end
  end

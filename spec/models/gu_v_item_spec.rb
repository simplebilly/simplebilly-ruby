...
# Unit tests for SimplebillyApi::GuVItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::GuVItem do
  #let(:instance) { SimplebillyApi::GuVItem.new }

  describe 'test an instance of GuVItem' do
    it 'should create an instance of GuVItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::GuVItem)
    end
  end

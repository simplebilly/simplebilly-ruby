...
# Unit tests for SimplebillyApi::ApplicationStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApplicationStatus do
  #let(:instance) { SimplebillyApi::ApplicationStatus.new }

  describe 'test an instance of ApplicationStatus' do
    it 'should create an instance of ApplicationStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApplicationStatus)
    end
  end

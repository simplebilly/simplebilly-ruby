...
# Unit tests for SimplebillyApi::RateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::RateRequest do
  #let(:instance) { SimplebillyApi::RateRequest.new }

  describe 'test an instance of RateRequest' do
    it 'should create an instance of RateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::RateRequest)
    end
  end

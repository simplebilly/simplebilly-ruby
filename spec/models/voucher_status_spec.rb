...
# Unit tests for SimplebillyApi::VoucherStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::VoucherStatus do
  #let(:instance) { SimplebillyApi::VoucherStatus.new }

  describe 'test an instance of VoucherStatus' do
    it 'should create an instance of VoucherStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::VoucherStatus)
    end
  end

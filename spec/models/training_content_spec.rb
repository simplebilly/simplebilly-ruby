...
# Unit tests for SimplebillyApi::TrainingContent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TrainingContent do
  #let(:instance) { SimplebillyApi::TrainingContent.new }

  describe 'test an instance of TrainingContent' do
    it 'should create an instance of TrainingContent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TrainingContent)
    end
  end
  ...
  describe 'test attribute "quiz"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

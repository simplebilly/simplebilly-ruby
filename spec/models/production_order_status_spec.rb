...
# Unit tests for SimplebillyApi::ProductionOrderStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ProductionOrderStatus do
  #let(:instance) { SimplebillyApi::ProductionOrderStatus.new }

  describe 'test an instance of ProductionOrderStatus' do
    it 'should create an instance of ProductionOrderStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ProductionOrderStatus)
    end
  end

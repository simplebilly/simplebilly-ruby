...
# Unit tests for SimplebillyApi::ShareholderUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ShareholderUpdate do
  #let(:instance) { SimplebillyApi::ShareholderUpdate.new }

  describe 'test an instance of ShareholderUpdate' do
    it 'should create an instance of ShareholderUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ShareholderUpdate)
    end
  end

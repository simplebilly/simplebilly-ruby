...
# Unit tests for SimplebillyApi::RateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::RateResponse do
  #let(:instance) { SimplebillyApi::RateResponse.new }

  describe 'test an instance of RateResponse' do
    it 'should create an instance of RateResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::RateResponse)
    end
  end

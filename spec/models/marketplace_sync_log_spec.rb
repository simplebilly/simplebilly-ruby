...
# Unit tests for SimplebillyApi::MarketplaceSyncLog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::MarketplaceSyncLog do
  #let(:instance) { SimplebillyApi::MarketplaceSyncLog.new }

  describe 'test an instance of MarketplaceSyncLog' do
    it 'should create an instance of MarketplaceSyncLog' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::MarketplaceSyncLog)
    end
  end

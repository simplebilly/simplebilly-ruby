...
# Unit tests for SimplebillyApi::OcrTextRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OcrTextRequest do
  #let(:instance) { SimplebillyApi::OcrTextRequest.new }

  describe 'test an instance of OcrTextRequest' do
    it 'should create an instance of OcrTextRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OcrTextRequest)
    end
  end

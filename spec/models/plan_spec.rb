...
# Unit tests for SimplebillyApi::Plan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Plan do
  #let(:instance) { SimplebillyApi::Plan.new }

  describe 'test an instance of Plan' do
    it 'should create an instance of Plan' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Plan)
    end
  end

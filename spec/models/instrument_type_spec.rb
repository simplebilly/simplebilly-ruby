...
# Unit tests for SimplebillyApi::InstrumentType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::InstrumentType do
  #let(:instance) { SimplebillyApi::InstrumentType.new }

  describe 'test an instance of InstrumentType' do
    it 'should create an instance of InstrumentType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::InstrumentType)
    end
  end

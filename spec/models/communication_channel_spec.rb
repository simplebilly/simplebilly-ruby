...
# Unit tests for SimplebillyApi::CommunicationChannel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::CommunicationChannel do
  #let(:instance) { SimplebillyApi::CommunicationChannel.new }

  describe 'test an instance of CommunicationChannel' do
    it 'should create an instance of CommunicationChannel' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::CommunicationChannel)
    end
  end

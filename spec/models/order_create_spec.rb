...
# Unit tests for SimplebillyApi::OrderCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OrderCreate do
  #let(:instance) { SimplebillyApi::OrderCreate.new }

  describe 'test an instance of OrderCreate' do
    it 'should create an instance of OrderCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OrderCreate)
    end
  end

  describe 'test attribute "audit_log"' do
    it 'should work' do

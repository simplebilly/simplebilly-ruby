...
# Unit tests for SimplebillyApi::ApiResponseVecTeam
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApiResponseVecTeam do
  #let(:instance) { SimplebillyApi::ApiResponseVecTeam.new }

  describe 'test an instance of ApiResponseVecTeam' do
    it 'should create an instance of ApiResponseVecTeam' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApiResponseVecTeam)
    end
  end

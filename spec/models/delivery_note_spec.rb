...
# Unit tests for SimplebillyApi::DeliveryNote
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::DeliveryNote do
  #let(:instance) { SimplebillyApi::DeliveryNote.new }

  describe 'test an instance of DeliveryNote' do
    it 'should create an instance of DeliveryNote' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::DeliveryNote)
    end
  end

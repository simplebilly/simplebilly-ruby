...
# Unit tests for SimplebillyApi::JobPostingUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::JobPostingUpdate do
  #let(:instance) { SimplebillyApi::JobPostingUpdate.new }

  describe 'test an instance of JobPostingUpdate' do
    it 'should create an instance of JobPostingUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::JobPostingUpdate)
    end
  end

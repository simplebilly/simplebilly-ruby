...
# Unit tests for SimplebillyApi::VoucherType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::VoucherType do
  #let(:instance) { SimplebillyApi::VoucherType.new }

  describe 'test an instance of VoucherType' do
    it 'should create an instance of VoucherType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::VoucherType)
    end
  end

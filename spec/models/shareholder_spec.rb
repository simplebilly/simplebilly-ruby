...
# Unit tests for SimplebillyApi::Shareholder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Shareholder do
  #let(:instance) { SimplebillyApi::Shareholder.new }

  describe 'test an instance of Shareholder' do
    it 'should create an instance of Shareholder' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Shareholder)
    end
  end

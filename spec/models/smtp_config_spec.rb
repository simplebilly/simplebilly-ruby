...
# Unit tests for SimplebillyApi::SmtpConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SmtpConfig do
  #let(:instance) { SimplebillyApi::SmtpConfig.new }

  describe 'test an instance of SmtpConfig' do
    it 'should create an instance of SmtpConfig' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SmtpConfig)
    end
  end

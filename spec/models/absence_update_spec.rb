...
# Unit tests for SimplebillyApi::AbsenceUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::AbsenceUpdate do
  #let(:instance) { SimplebillyApi::AbsenceUpdate.new }

  describe 'test an instance of AbsenceUpdate' do
    it 'should create an instance of AbsenceUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::AbsenceUpdate)
    end
  end

  describe 'test attribute "absence_type"' do
    it 'should work' do

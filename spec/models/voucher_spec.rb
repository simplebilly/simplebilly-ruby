...
# Unit tests for SimplebillyApi::Voucher
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Voucher do
  #let(:instance) { SimplebillyApi::Voucher.new }

  describe 'test an instance of Voucher' do
    it 'should create an instance of Voucher' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Voucher)
    end
  end

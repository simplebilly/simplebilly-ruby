...
# Unit tests for SimplebillyApi::AttachmentVersion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::AttachmentVersion do
  #let(:instance) { SimplebillyApi::AttachmentVersion.new }

  describe 'test an instance of AttachmentVersion' do
    it 'should create an instance of AttachmentVersion' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::AttachmentVersion)
    end
  end

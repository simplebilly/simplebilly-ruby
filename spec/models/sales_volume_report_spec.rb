...
# Unit tests for SimplebillyApi::SalesVolumeReport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::SalesVolumeReport do
  #let(:instance) { SimplebillyApi::SalesVolumeReport.new }

  describe 'test an instance of SalesVolumeReport' do
    it 'should create an instance of SalesVolumeReport' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::SalesVolumeReport)
    end
  end

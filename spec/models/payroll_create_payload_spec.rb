...
# Unit tests for SimplebillyApi::PayrollCreatePayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PayrollCreatePayload do
  #let(:instance) { SimplebillyApi::PayrollCreatePayload.new }

  describe 'test an instance of PayrollCreatePayload' do
    it 'should create an instance of PayrollCreatePayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PayrollCreatePayload)
    end
  end

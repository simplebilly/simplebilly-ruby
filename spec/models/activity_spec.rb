...
# Unit tests for SimplebillyApi::Activity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Activity do
  #let(:instance) { SimplebillyApi::Activity.new }

  describe 'test an instance of Activity' do
    it 'should create an instance of Activity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Activity)
    end
  end

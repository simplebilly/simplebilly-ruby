...
# Unit tests for SimplebillyApi::TrainingAssignmentUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::TrainingAssignmentUpdate do
  #let(:instance) { SimplebillyApi::TrainingAssignmentUpdate.new }

  describe 'test an instance of TrainingAssignmentUpdate' do
    it 'should create an instance of TrainingAssignmentUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::TrainingAssignmentUpdate)
    end
  end

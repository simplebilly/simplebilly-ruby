...
# Unit tests for SimplebillyApi::Gender
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::Gender do
  #let(:instance) { SimplebillyApi::Gender.new }

  describe 'test an instance of Gender' do
    it 'should create an instance of Gender' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::Gender)
    end
  end

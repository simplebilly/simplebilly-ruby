...
# Unit tests for SimplebillyApi::PackingQueue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PackingQueue do
  #let(:instance) { SimplebillyApi::PackingQueue.new }

  describe 'test an instance of PackingQueue' do
    it 'should create an instance of PackingQueue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PackingQueue)
    end
  end

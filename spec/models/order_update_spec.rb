...
# Unit tests for SimplebillyApi::OrderUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OrderUpdate do
  #let(:instance) { SimplebillyApi::OrderUpdate.new }

  describe 'test an instance of OrderUpdate' do
    it 'should create an instance of OrderUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OrderUpdate)
    end
  end

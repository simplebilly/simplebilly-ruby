...
# Unit tests for SimplebillyApi::PlausibilityCheck
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::PlausibilityCheck do
  #let(:instance) { SimplebillyApi::PlausibilityCheck.new }

  describe 'test an instance of PlausibilityCheck' do
    it 'should create an instance of PlausibilityCheck' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::PlausibilityCheck)
    end
  end

...
# Unit tests for SimplebillyApi::WarehouseUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::WarehouseUpdate do
  #let(:instance) { SimplebillyApi::WarehouseUpdate.new }

  describe 'test an instance of WarehouseUpdate' do
    it 'should create an instance of WarehouseUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::WarehouseUpdate)
    end
  end

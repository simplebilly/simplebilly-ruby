...
# Unit tests for SimplebillyApi::ApiResponseVecPlanDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApiResponseVecPlanDataInner do
  #let(:instance) { SimplebillyApi::ApiResponseVecPlanDataInner.new }

  describe 'test an instance of ApiResponseVecPlanDataInner' do
    it 'should create an instance of ApiResponseVecPlanDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApiResponseVecPlanDataInner)
    end
  end

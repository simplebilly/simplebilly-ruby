...
# Unit tests for SimplebillyApi::AttachmentCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::AttachmentCreate do
  #let(:instance) { SimplebillyApi::AttachmentCreate.new }

  describe 'test an instance of AttachmentCreate' do
    it 'should create an instance of AttachmentCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::AttachmentCreate)
    end
  end

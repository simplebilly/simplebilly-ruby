...
# Unit tests for SimplebillyApi::OrderConfirmation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::OrderConfirmation do
  #let(:instance) { SimplebillyApi::OrderConfirmation.new }

  describe 'test an instance of OrderConfirmation' do
    it 'should create an instance of OrderConfirmation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::OrderConfirmation)
    end
  end

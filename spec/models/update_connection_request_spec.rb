...
# Unit tests for SimplebillyApi::UpdateConnectionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::UpdateConnectionRequest do
  #let(:instance) { SimplebillyApi::UpdateConnectionRequest.new }
  ...
  describe 'test an instance of UpdateConnectionRequest' do
    it 'should create an instance of UpdateConnectionRequest' do
      ...
      #expect(instance).to be_instance_of(SimplebillyApi::UpdateConnectionRequest)
    end
  end

...
# Unit tests for SimplebillyApi::ApiResponseTeam
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ApiResponseTeam do
  #let(:instance) { SimplebillyApi::ApiResponseTeam.new }

  describe 'test an instance of ApiResponseTeam' do
    it 'should create an instance of ApiResponseTeam' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ApiResponseTeam)
    end
  end

...
# Unit tests for SimplebillyApi::WebhookEventStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::WebhookEventStatus do
  #let(:instance) { SimplebillyApi::WebhookEventStatus.new }

  describe 'test an instance of WebhookEventStatus' do
    it 'should create an instance of WebhookEventStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::WebhookEventStatus)
    end
  end

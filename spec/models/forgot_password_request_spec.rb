...
# Unit tests for SimplebillyApi::ForgotPasswordRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::ForgotPasswordRequest do
  #let(:instance) { SimplebillyApi::ForgotPasswordRequest.new }

  describe 'test an instance of ForgotPasswordRequest' do
    it 'should create an instance of ForgotPasswordRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::ForgotPasswordRequest)
    end
  end

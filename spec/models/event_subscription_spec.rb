...
# Unit tests for SimplebillyApi::EventSubscription
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SimplebillyApi::EventSubscription do
  #let(:instance) { SimplebillyApi::EventSubscription.new }

  describe 'test an instance of EventSubscription' do
    it 'should create an instance of EventSubscription' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SimplebillyApi::EventSubscription)
    end
  end

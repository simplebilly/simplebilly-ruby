...
module SimplebillyApi
  class ReturnOrderStatus
    ...
    INSPECTED = "inspected".freeze
    RESTOCKED = "restocked".freeze
    CLOSED = "closed".freeze

    def self.all_vars
      @all_vars ||= [REQUESTED, RECEIVED, INSPECTED, RESTOCKED, CLOSED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ReturnOrderStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ReturnOrderStatus"
    end
  end
end

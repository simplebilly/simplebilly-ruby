...
module SimplebillyApi
  class AbsenceStatus
    ...
    def self.all_vars
      @all_vars ||= [PENDING, APPROVED, REJECTED, CANCELLED].freeze
    end
    ...
    def build_from_hash(value)
      return value if AbsenceStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AbsenceStatus"
    end
  end
end

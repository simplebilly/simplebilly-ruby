...
module SimplebillyApi
  class InstrumentType
    TYPISCH = "typisch".freeze
    ATYPISCH = "atypisch".freeze

    def self.all_vars
      @all_vars ||= [TYPISCH, ATYPISCH].freeze
    end
    ...
    def build_from_hash(value)
      return value if InstrumentType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #InstrumentType"
    end
  end
end

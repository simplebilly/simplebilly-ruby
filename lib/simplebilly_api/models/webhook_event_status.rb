...
module SimplebillyApi
  class WebhookEventStatus
    ...
    def self.all_vars
      @all_vars ||= [ACCEPTED, DELIVERED, FAILED, RECEIVED].freeze
    end
    ...
    def build_from_hash(value)
      return value if WebhookEventStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #WebhookEventStatus"
    end
  end
end

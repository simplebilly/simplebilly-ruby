...
module SimplebillyApi
  class DeliveryDateStatus
    ...
    def self.all_vars
      @all_vars ||= [PROMISED, CONFIRMED, RESCHEDULED, FULFILLED, LATE, CANCELLED].freeze
    end
    ...
    def build_from_hash(value)
      return value if DeliveryDateStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #DeliveryDateStatus"
    end
  end
end

...
module SimplebillyApi
  class InventoryCountStatus
    DRAFT = "draft".freeze
    COUNTING = "counting".freeze
    REVIEWED = "reviewed".freeze
    POSTED = "posted".freeze

    def self.all_vars
      @all_vars ||= [DRAFT, COUNTING, REVIEWED, POSTED].freeze
    end
    ...
    def build_from_hash(value)
      return value if InventoryCountStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #InventoryCountStatus"
    end
  end
end

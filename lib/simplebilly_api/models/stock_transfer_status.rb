...
module SimplebillyApi
  class StockTransferStatus
    ...
    def self.all_vars
      @all_vars ||= [DRAFT, COMPLETED, CANCELLED].freeze
    end
    ...
    def build_from_hash(value)
      return value if StockTransferStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StockTransferStatus"
    end
  end
end

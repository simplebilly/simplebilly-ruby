...
module SimplebillyApi
  class AccountOverview < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SimplebillyApi::AccountOverview` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SimplebillyApi::AccountOverview`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'credit_total')
        ...
        self.credit_total = nil
      end

      if attributes.key?(:'debit_total')
        self.debit_total = attributes[:'debit_total']
      else
        self.debit_total = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @credit_total.nil?
        invalid_properties.push('invalid value for "credit_total", credit_total cannot be nil.')
      end

      if @debit_total.nil?
        invalid_properties.push('invalid value for "debit_total", debit_total cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @credit_total.nil?
      return false if @debit_total.nil?
      true
    end
    ...
    def credit_total=(credit_total)
      if credit_total.nil?
        fail ArgumentError, 'credit_total cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] debit_total Value to be assigned
    def debit_total=(debit_total)
      if debit_total.nil?
        fail ArgumentError, 'debit_total cannot be nil'
      end
    ...
    def hash
      [account, account_name, balance, credit_total, debit_total].hash
    end

...
module SimplebillyApi
  class PayrollRunStatus
    ...
    def self.all_vars
      @all_vars ||= [DRAFT, CALCULATED, APPROVED, PAID].freeze
    end
    ...
    def build_from_hash(value)
      return value if PayrollRunStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PayrollRunStatus"
    end
  end
end

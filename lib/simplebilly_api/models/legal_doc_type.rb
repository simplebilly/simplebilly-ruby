...
module SimplebillyApi
  class LegalDocType
    ...
    GPSR = "gpsr".freeze
    COOKIE_NOTICE = "cookie_notice".freeze

    def self.all_vars
      @all_vars ||= [IMPRINT, PRIVACY, TERMS, WITHDRAWAL, REFUND, SHIPPING, GPSR, COOKIE_NOTICE].freeze
    end
    ...
    def build_from_hash(value)
      return value if LegalDocType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #LegalDocType"
    end
  end
end

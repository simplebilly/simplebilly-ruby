...
module SimplebillyApi
  class ServiceJobStatus
    ...
    def self.all_vars
      @all_vars ||= [PENDING, ASSIGNED, EN_ROUTE, IN_PROGRESS, COMPLETED, CANCELLED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ServiceJobStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ServiceJobStatus"
    end
  end
end

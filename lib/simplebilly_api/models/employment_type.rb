...
module SimplebillyApi
  class EmploymentType
    ...
    def self.all_vars
      @all_vars ||= [FULLTIME, PARTTIME, CONTRACT, INTERNSHIP, TEMPORARY].freeze
    end
    ...
    def build_from_hash(value)
      return value if EmploymentType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #EmploymentType"
    end
  end
end

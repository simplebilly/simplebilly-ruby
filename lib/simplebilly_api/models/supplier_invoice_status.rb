...
module SimplebillyApi
  class SupplierInvoiceStatus
    ...
    HAS_VARIANCES = "has_variances".freeze
    POSTED = "posted".freeze
    CANCELLED = "cancelled".freeze

    def self.all_vars
      @all_vars ||= [DRAFT, MATCHED, HAS_VARIANCES, POSTED, CANCELLED].freeze
    end
    ...
    def build_from_hash(value)
      return value if SupplierInvoiceStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #SupplierInvoiceStatus"
    end
  end
end

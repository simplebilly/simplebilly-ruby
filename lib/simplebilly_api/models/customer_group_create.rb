...
module SimplebillyApi
  class CustomerGroupCreate < ApiModelBase
    ...
    attr_accessor :membership_filter
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SimplebillyApi::CustomerGroupCreate` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SimplebillyApi::CustomerGroupCreate`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'membership_filter')
        self.membership_filter = attributes[:'membership_filter']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          membership_filter == o.membership_filter &&
          name == o.name
    end
    ...
    def hash
      [description, member_ids, membership_filter, name].hash
    end

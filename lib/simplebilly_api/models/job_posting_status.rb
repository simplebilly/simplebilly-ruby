...
module SimplebillyApi
  class JobPostingStatus
    ...
    def self.all_vars
      @all_vars ||= [DRAFT, PUBLISHED, CLOSED].freeze
    end
    ...
    def build_from_hash(value)
      return value if JobPostingStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #JobPostingStatus"
    end
  end
end

  ...
  class DeliveryDateCreate < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SimplebillyApi::DeliveryDateCreate` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SimplebillyApi::DeliveryDateCreate`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fulfilled_date')
        self.fulfilled_date = attributes[:'fulfilled_date']
      end
      ...
      if attributes.key?(:'promised_date')
        self.promised_date = attributes[:'promised_date']
      else
        self.promised_date = nil
      end
    ...
    def list_invalid_properties
      ...
      if @promised_date.nil?
        invalid_properties.push('invalid value for "promised_date", promised_date cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @promised_date.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] promised_date Value to be assigned
    def promised_date=(promised_date)
      if promised_date.nil?
        fail ArgumentError, 'promised_date cannot be nil'
      end
    ...
    def hash
      [customer_id, fulfilled_date, note, order_number, original_date, product_id, promised_date, status].hash
    end

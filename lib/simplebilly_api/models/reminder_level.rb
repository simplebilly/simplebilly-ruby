...
module SimplebillyApi
  class ReminderLevel
    ...
    def self.all_vars
      @all_vars ||= [NONE, DUE, LEVEL1, LEVEL2, LEVEL3].freeze
    end
    ...
    def build_from_hash(value)
      return value if ReminderLevel.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ReminderLevel"
    end
  end
end

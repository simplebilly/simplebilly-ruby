...
module SimplebillyApi
  class LeadStatus
    NEW = "new".freeze
    QUALIFIED = "qualified".freeze

    def self.all_vars
      @all_vars ||= [NEW, QUALIFIED].freeze
    end
    ...
    def build_from_hash(value)
      return value if LeadStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #LeadStatus"
    end
  end
end

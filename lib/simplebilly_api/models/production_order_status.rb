...
module SimplebillyApi
  class ProductionOrderStatus
    ...
    IN_PRODUCTION = "in_production".freeze
    COMPLETED = "completed".freeze
    CANCELLED = "cancelled".freeze

    def self.all_vars
      @all_vars ||= [PLANNED, IN_PRODUCTION, COMPLETED, CANCELLED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProductionOrderStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ProductionOrderStatus"
    end
  end
end

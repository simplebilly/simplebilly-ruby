...
module SimplebillyApi
  class RfqStatus
    ...
    def self.all_vars
      @all_vars ||= [DRAFT, SENT, OFFER_RECEIVED, REJECTED, CONVERTED].freeze
    end
    ...
    def build_from_hash(value)
      return value if RfqStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #RfqStatus"
    end
  end
end

...
module SimplebillyApi
  class PrecedingSalesVoucherType
    ...
    PROFORMA_INVOICE = "proforma_invoice".freeze

    def self.all_vars
      @all_vars ||= [ORDER_CONFIRMATION, QUOTATION, PROFORMA_INVOICE].freeze
    end
    ...
    def build_from_hash(value)
      return value if PrecedingSalesVoucherType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PrecedingSalesVoucherType"
    end
  end
end

...
module SimplebillyApi
  class SmtpEncryption
    START_TLS = "StartTls".freeze
    TLS = "Tls".freeze

    def self.all_vars
      @all_vars ||= [START_TLS, TLS].freeze
    end
    ...
    def build_from_hash(value)
      return value if SmtpEncryption.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #SmtpEncryption"
    end
  end
end

...
module SimplebillyApi
  class ServiceAssignmentStatus
    ...
    EN_ROUTE = "en_route".freeze
    IN_PROGRESS = "in_progress".freeze
    COMPLETED = "completed".freeze
    CANCELLED = "cancelled".freeze

    def self.all_vars
      @all_vars ||= [PLANNED, CONFIRMED, EN_ROUTE, IN_PROGRESS, COMPLETED, CANCELLED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ServiceAssignmentStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ServiceAssignmentStatus"
    end
  end
end

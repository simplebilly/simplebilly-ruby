...
module SimplebillyApi
  class DocumentType
    ...
    CREDITNOTE = "creditnote".freeze
    ADVANCEPAYMENT = "advancepayment".freeze
    DOWNPAYMENTINVOICE = "downpaymentinvoice".freeze
    DELIVERYNOTE = "deliverynote".freeze
    ORDERCONFIRMATION = "orderconfirmation".freeze
    QUOTATION = "quotation".freeze
    PROFORMAINVOICE = "proformainvoice".freeze

    def self.all_vars
      @all_vars ||= [INVOICE, CREDITNOTE, ADVANCEPAYMENT, DOWNPAYMENTINVOICE, DELIVERYNOTE, ORDERCONFIRMATION, QUOTATION, PROFORMAINVOICE].freeze
    end

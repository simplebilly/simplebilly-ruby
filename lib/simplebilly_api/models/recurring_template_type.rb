...
module SimplebillyApi
  class RecurringTemplateType
    ...
    def self.all_vars
      @all_vars ||= [INVOICE, REPORT].freeze
    end
    ...
    def build_from_hash(value)
      return value if RecurringTemplateType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #RecurringTemplateType"
    end
  end
end

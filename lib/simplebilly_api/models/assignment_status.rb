...
module SimplebillyApi
  class AssignmentStatus
    ...
    WAIVED = "waived".freeze

    def self.all_vars
      @all_vars ||= [REQUIRED, COMPLETED, OVERDUE, WAIVED].freeze
    end
    ...
    def build_from_hash(value)
      return value if AssignmentStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AssignmentStatus"
    end
  end
end

...
module SimplebillyApi
  class ProformaInvoiceStatus
    ...
    def self.all_vars
      @all_vars ||= [DRAFT, SENT, CONVERTED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProformaInvoiceStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ProformaInvoiceStatus"
    end
  end
end

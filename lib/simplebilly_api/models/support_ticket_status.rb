...
module SimplebillyApi
  class SupportTicketStatus
    OPEN = "open".freeze
    AWAITING_REPLY = "awaiting_reply".freeze
    RESOLVED = "resolved".freeze
    CLOSED = "closed".freeze

    def self.all_vars
      @all_vars ||= [OPEN, AWAITING_REPLY, RESOLVED, CLOSED].freeze
    end
    ...
    def build_from_hash(value)
      return value if SupportTicketStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #SupportTicketStatus"
    end
  end
end

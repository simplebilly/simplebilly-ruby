...
module SimplebillyApi
  class CommunicationChannel
    ...
    def self.all_vars
      @all_vars ||= [EMAIL, CALL, MEETING, CHAT, NOTE].freeze
    end
    ...
    def build_from_hash(value)
      return value if CommunicationChannel.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #CommunicationChannel"
    end
  end
end

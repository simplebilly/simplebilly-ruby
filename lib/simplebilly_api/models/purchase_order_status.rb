...
module SimplebillyApi
  class PurchaseOrderStatus
    ...
    PARTIALLY_RECEIVED = "partially_received".freeze
    RECEIVED = "received".freeze
    CANCELLED = "cancelled".freeze

    def self.all_vars
      @all_vars ||= [DRAFT, ORDERED, PARTIALLY_RECEIVED, RECEIVED, CANCELLED].freeze
    end
    ...
    def build_from_hash(value)
      return value if PurchaseOrderStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PurchaseOrderStatus"
    end
  end
end

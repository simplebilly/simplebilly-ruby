...
module SimplebillyApi
  class DeliveryAppointmentStatus
    ...
    def self.all_vars
      @all_vars ||= [REQUESTED, CONFIRMED, ARRIVED, CANCELLED, COMPLETED].freeze
    end
    ...
    def build_from_hash(value)
      return value if DeliveryAppointmentStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #DeliveryAppointmentStatus"
    end
  end
end

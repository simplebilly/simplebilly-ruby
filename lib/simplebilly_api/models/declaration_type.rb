...
module SimplebillyApi
  class DeclarationType
    DCGK = "dcgk".freeze
    UNTERNEHMENSFUEHRUNG = "unternehmensfuehrung".freeze

    def self.all_vars
      @all_vars ||= [DCGK, UNTERNEHMENSFUEHRUNG].freeze
    end
    ...
    def build_from_hash(value)
      return value if DeclarationType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #DeclarationType"
    end
  end
end

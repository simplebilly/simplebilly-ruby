...
module SimplebillyApi
  class MessageDirection
    ...
    def self.all_vars
      @all_vars ||= [INBOUND, OUTBOUND, INTERNAL].freeze
    end
    ...
    def build_from_hash(value)
      return value if MessageDirection.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #MessageDirection"
    end
  end
end
